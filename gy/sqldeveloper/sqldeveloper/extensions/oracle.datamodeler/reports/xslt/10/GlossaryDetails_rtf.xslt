	...
	<xsl:template name="altova:DocumentSection_0">
		...
		<xsl:for-each select="$XML">
			<xsl:for-each select="n1:root">
				...
				<xsl:variable name="altova:nSumColumnWidthsTw_0" select="round(8504.94)"/>
				...
				<xsl:variable name="altova:nColumnWidthTw_0_1" select="round(4.33 * 1440 * $altova:TableWidthFactor_0)"/>
				<xsl:text>\pard</xsl:text>
				...
				<xsl:variable name="altova:nSumColumnWidthsTw_1" select="round(14177.73)"/>
				...
				<xsl:variable name="altova:nColumnWidthTw_1_3" select="round(1.57 * 1440 * $altova:TableWidthFactor_1)"/>
				<xsl:variable name="altova:nColumnWidthTw_1_4" select="round(0.39 * 1440 * $altova:TableWidthFactor_1)"/>
				<xsl:variable name="altova:nColumnWidthTw_1_5" select="round(0.39 * 1440 * $altova:TableWidthFactor_1)"/>
				<xsl:variable name="altova:nColumnWidthTw_1_6" select="round(0.39 * 1440 * $altova:TableWidthFactor_1)"/>
				<xsl:variable name="altova:nColumnWidthTw_1_7" select="round(0.39 * 1440 * $altova:TableWidthFactor_1)"/>
				<xsl:variable name="altova:nColumnWidthTw_1_8" select="round(1.97 * 1440 * $altova:TableWidthFactor_1)"/>
				<xsl:text>\par </xsl:text>
				<xsl:text>\pard</xsl:text>
				<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
				<xsl:text>\itap</xsl:text>
						...
						<xsl:choose>
							<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
								<xsl:for-each select="n1:P">
									<xsl:apply-templates>
										<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_1_4 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
										<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
									</xsl:apply-templates>
								</xsl:for-each>
							</xsl:when>
						...
						<xsl:choose>
							<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
								<xsl:for-each select="n1:C">
									<xsl:apply-templates>
										<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_1_5 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
										<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
									</xsl:apply-templates>
								</xsl:for-each>
							</xsl:when>
						...
						<xsl:choose>
							<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
								<xsl:for-each select="n1:M">
									<xsl:apply-templates>
										<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_1_6 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
										<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
									</xsl:apply-templates>
								</xsl:for-each>
							</xsl:when>
						...
						<xsl:choose>
							<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
								<xsl:for-each select="n1:Q">
									<xsl:apply-templates>
										<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_1_7 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
										<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
									</xsl:apply-templates>
								</xsl:for-each>
							</xsl:when>
								...
								<xsl:for-each select="n1:SDescription">
									<xsl:for-each select="n1:SDescriptionDetails">
										<xsl:for-each select="n1:SDescriptionRow">
											<xsl:apply-templates>
												<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_1_8 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
												<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
											</xsl:apply-templates>
											<xsl:text>\par </xsl:text>
										</xsl:for-each>
