...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_oc" xmlns:n2="osdm_ad" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="altova altovaext clitype fn iso4217 ix java link n1 n2 sps xbrldi xbrli xlink xs xsd xsi">
	...
	<xsl:template match="*" priority="-1.0">
		<xsl:param name="altova:nMaxWidthIn" select="6.70833"/>
	...
	<xsl:template match="/">
		<xsl:variable name="altova:nMaxWidthIn" select="6.70833"/>
		...
		<xsl:call-template name="altova:DocumentSection_0">
			<xsl:with-param name="altova:nMaxWidthIn" select="6.71"/>
			<xsl:with-param name="templatetablelevel" select="$templatetablelevel"/>
		</xsl:call-template>
		<xsl:text>}</xsl:text>
	</xsl:template>
	<xsl:template name="altova:DocumentSection_0">
		...
		<xsl:text>\sectd\facingp\pgwsxn11900\pghsxn16820\margtsxn-1120\marglsxn1120\margbsxn-1120\margrsxn1120\headery380\footery380\cols1\colsx0\pgndec</xsl:text>
		<xsl:text>{</xsl:text>
			...
			<xsl:for-each select="n1:root">
				...
				<xsl:if test="string-length(n1:DesignName) &gt; 0">
					...
					<xsl:variable name="altova:nTableWidthIn_0">
						<xsl:choose>
							<xsl:when test="6.69291 &gt; $altova:nMaxWidthIn">
								<xsl:value-of select="$altova:nMaxWidthIn"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="6.69291"/>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:variable>
					...
					<xsl:variable name="altova:nSumColumnWidthsTw_0" select="round(9638.79)"/>
					...
					<xsl:variable name="altova:nColumnWidthTw_0_1" select="round(5.12 * 1440 * $altova:TableWidthFactor_0)"/>
					<xsl:text>\pard</xsl:text>
						...
						<xsl:choose>
							<xsl:when test="n1:IsDMDImport = &apos;Y&apos;">
								<xsl:if test="count(//n1:Object[@Status=&apos;Modified&apos;]) &gt; 0">
									...
									<xsl:variable name="altova:nSumColumnWidthsTw_1" select="round(9640.29)"/>
									...
									<xsl:variable name="altova:nColumnWidthTw_1_1" select="round(1.57 * 1440 * $altova:TableWidthFactor_1)"/>
									<xsl:variable name="altova:nColumnWidthTw_1_2" select="round(1.57 * 1440 * $altova:TableWidthFactor_1)"/>
									<xsl:variable name="altova:nColumnWidthTw_1_3" select="round(1.18 * 1440 * $altova:TableWidthFactor_1)"/>
									<xsl:variable name="altova:nColumnWidthTw_1_4" select="round(0.79 * 1440 * $altova:TableWidthFactor_1)"/>
									<xsl:text>\par </xsl:text>
									<xsl:text>\pard</xsl:text>
									<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
									<xsl:text>\itap</xsl:text>
										...
										<xsl:for-each select="n1:ObjectDetails">
											<xsl:for-each select="n1:Object[@Status = &apos;Modified&apos;]">
												<xsl:variable name="altova:RowStyle4">
													...
													<xsl:variable name="altova:CurrGridPos_Tbl1_Col0_AfterColumn" select="$altova:CurrGridPos_Tbl1 + $altova:nColumnWidthTw_1_0"/>
													<xsl:value-of select="ceiling($altova:CurrGridPos_Tbl1_Col0_AfterColumn)"/>
													<xsl:text>\clvertalc\clcbpat142\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
													<xsl:if test="$altova:nColumnWidthTw_1_1 = $altova:nDefaultColumnWidthTw_1">
														<xsl:text>\clftsWidth1</xsl:text>
													</xsl:if>
													<xsl:text>\cellx</xsl:text>
													...
													<xsl:choose>
														<xsl:when test="count( n1:PropertyDetails ) &gt;0">
															<xsl:variable name="altova:RowStyle5">
																<xsl:text>\trrh0</xsl:text>
																<xsl:variable name="altova:CurrGridPos_Tbl1" select="$altova:nTableIndentTw_1"/>
																<xsl:text>\clvertalc\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrl\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
																<xsl:if test="$altova:nColumnWidthTw_1_0 = $altova:nDefaultColumnWidthTw_1">
																	<xsl:text>\clftsWidth1</xsl:text>
																</xsl:if>
																<xsl:text>\cellx</xsl:text>
																<xsl:variable name="altova:CurrGridPos_Tbl1_Col0_AfterColumn" select="$altova:CurrGridPos_Tbl1 + $altova:nColumnWidthTw_1_0"/>
																<xsl:value-of select="ceiling($altova:CurrGridPos_Tbl1_Col0_AfterColumn)"/>
																<xsl:text>\clvertalc\clmgf\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
																<xsl:if test="$altova:nColumnWidthTw_1_1 = $altova:nDefaultColumnWidthTw_1">
																	<xsl:text>\clftsWidth1</xsl:text>
																</xsl:if>
																<xsl:text>\cellx</xsl:text>
																<xsl:variable name="altova:CurrGridPos_Tbl1_Col1_AfterColumn" select="$altova:CurrGridPos_Tbl1_Col0_AfterColumn + $altova:nColumnWidthTw_1_1"/>
																<xsl:value-of select="ceiling($altova:CurrGridPos_Tbl1_Col1_AfterColumn)"/>
																<xsl:text>\clvertalc\clmrg\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
																<xsl:if test="$altova:nColumnWidthTw_1_2 = $altova:nDefaultColumnWidthTw_1">
																	<xsl:text>\clftsWidth1</xsl:text>
																</xsl:if>
																<xsl:text>\cellx</xsl:text>
															...
															<xsl:variable name="altova:nTableWidthIn_2" select="$altova:nColumnWidthTw_1_1 div 1440 * 1.00000 + $altova:nColumnWidthTw_1_2 div 1440 * 1.00000 + $altova:nColumnWidthTw_1_3 div 1440 * 1.00000 + $altova:nColumnWidthTw_1_4 div 1440 * 1.00000 - 0.02000 - 0.03125 - 0.03125"/>
															...
															<xsl:variable name="altova:nSumColumnWidthsTw_2" select="round(9071.87)"/>
															...
															<xsl:variable name="altova:nColumnWidthTw_2_0" select="round(1.18 * 1440 * $altova:TableWidthFactor_2)"/>
															<xsl:variable name="altova:nColumnWidthTw_2_1" select="round(5.12 * 1440 * $altova:TableWidthFactor_2)"/>
															<xsl:text>\pard</xsl:text>
															...
															<xsl:variable name="altova:nTableWidthIn_3">
																<xsl:choose>
																	<xsl:when test="4.72441 &gt; $altova:nColumnWidthTw_2_1">
																		<xsl:value-of select="$altova:nColumnWidthTw_2_1"/>
																	</xsl:when>
																	<xsl:otherwise>
																		<xsl:value-of select="4.72441"/>
																	</xsl:otherwise>
																</xsl:choose>
															</xsl:variable>
															...
															<xsl:variable name="altova:nSumColumnWidthsTw_3" select="round(6804.65)"/>
															...
															<xsl:variable name="altova:nColumnWidthTw_3_2" select="round(1.57 * 1440 * $altova:TableWidthFactor_3)"/>
															<xsl:text>\pard</xsl:text>
															<xsl:if test="$templatetablelevel + 3 &gt; 0">\intbl</xsl:if>
															<xsl:text>\itap</xsl:text>
															<xsl:value-of select="$templatetablelevel + 3"/>
															...
															<xsl:variable name="rowend3">
																<xsl:choose>
																	<xsl:when test="$templatetablelevel + 3 = 1">
																		<xsl:text>\row\pard</xsl:text>
																	</xsl:when>
																	<xsl:otherwise>
																		<xsl:text>\nestrow}{\nonesttables\par}</xsl:text>
															...
															<xsl:variable name="altova:RowStyle7">
																<xsl:text>\trrh6</xsl:text>
																<xsl:variable name="altova:CurrGridPos_Tbl3" select="$altova:nTableIndentTw_3"/>
																<xsl:text>\clvertalc\clbrdrb\brdrdot\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
															...
															<xsl:if test="$templatetablelevel + 3 = 1">
															...
															<xsl:for-each select="n1:PropertyDetails">
																<xsl:variable name="altova:RowStyle8">
																	<xsl:text>\trrh0</xsl:text>
																	<xsl:variable name="altova:CurrGridPos_Tbl3" select="$altova:nTableIndentTw_3"/>
																	<xsl:text>\clvertalc\clbrdrb\brdrdot\brdrcf1\brdrw28\clbrdrl\brdrdot\brdrcf1\brdrw28\clbrdrr\brdrdot\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
																	<xsl:if test="$altova:nColumnWidthTw_3_0 = $altova:nDefaultColumnWidthTw_3">
																		<xsl:text>\clftsWidth1</xsl:text>
																	</xsl:if>
																	<xsl:text>\cellx</xsl:text>
																	<xsl:variable name="altova:CurrGridPos_Tbl3_Col0_AfterColumn" select="$altova:CurrGridPos_Tbl3 + $altova:nColumnWidthTw_3_0"/>
																	<xsl:value-of select="ceiling($altova:CurrGridPos_Tbl3_Col0_AfterColumn)"/>
																	<xsl:text>\clvertalc\clbrdrb\brdrdot\brdrcf1\brdrw28\clbrdrr\brdrdot\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
																	<xsl:if test="$altova:nColumnWidthTw_3_1 = $altova:nDefaultColumnWidthTw_3">
																		<xsl:text>\clftsWidth1</xsl:text>
																	</xsl:if>
																	<xsl:text>\cellx</xsl:text>
																	...
																	<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
																		<xsl:for-each select="n1:PropertyName">
																			<xsl:apply-templates>
																				...
																				<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 3"/>
																			</xsl:apply-templates>
																			<xsl:text>\par </xsl:text>
																		</xsl:for-each>
																	</xsl:when>
																...
																<xsl:choose>
																	<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
																		<xsl:for-each select="n1:PropertyNewValue">
																			<xsl:apply-templates>
																				<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_3_2 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
																				<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 3"/>
																			</xsl:apply-templates>
																			<xsl:text>\par </xsl:text>
																		</xsl:for-each>
								...
								<xsl:if test="count(//n1:Object[@Status=&apos;New&apos;]) &gt; 0">
									...
									<xsl:variable name="altova:nSumColumnWidthsTw_4" select="round(9640.29)"/>
									...
									<xsl:variable name="altova:nColumnWidthTw_4_1" select="round(1.57 * 1440 * $altova:TableWidthFactor_4)"/>
									<xsl:variable name="altova:nColumnWidthTw_4_2" select="round(1.57 * 1440 * $altova:TableWidthFactor_4)"/>
									<xsl:variable name="altova:nColumnWidthTw_4_3" select="round(1.18 * 1440 * $altova:TableWidthFactor_4)"/>
									<xsl:variable name="altova:nColumnWidthTw_4_4" select="round(0.79 * 1440 * $altova:TableWidthFactor_4)"/>
									<xsl:text>\par </xsl:text>
									<xsl:text>\pard</xsl:text>
									<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
									<xsl:text>\itap</xsl:text>
								...
								<xsl:if test="count(//n1:Object[@Status=&apos;Deleted&apos;]) &gt; 0">
									...
									<xsl:variable name="altova:nSumColumnWidthsTw_5" select="round(9640.29)"/>
									...
									<xsl:variable name="altova:nColumnWidthTw_5_2" select="round(1.57 * 1440 * $altova:TableWidthFactor_5)"/>
									<xsl:variable name="altova:nColumnWidthTw_5_3" select="round(1.18 * 1440 * $altova:TableWidthFactor_5)"/>
									<xsl:variable name="altova:nColumnWidthTw_5_4" select="round(0.79 * 1440 * $altova:TableWidthFactor_5)"/>
									<xsl:text>\par </xsl:text>
									<xsl:text>\pard</xsl:text>
									<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
									<xsl:text>\itap</xsl:text>
							...
							<xsl:otherwise>
								<xsl:if test="count(//n1:Object[@Status=&apos;Modified&apos;]) &gt; 0">
									...
									<xsl:variable name="altova:nSumColumnWidthsTw_6" select="round(9639.80)"/>
									...
									<xsl:variable name="altova:nColumnWidthTw_6_0" select="round(2.36 * 1440 * $altova:TableWidthFactor_6)"/>
									<xsl:variable name="altova:nColumnWidthTw_6_1" select="round(2.36 * 1440 * $altova:TableWidthFactor_6)"/>
									<xsl:variable name="altova:nColumnWidthTw_6_2" select="round(1.18 * 1440 * $altova:TableWidthFactor_6)"/>
									<xsl:variable name="altova:nColumnWidthTw_6_3" select="round(0.79 * 1440 * $altova:TableWidthFactor_6)"/>
									<xsl:text>\par </xsl:text>
									<xsl:text>\pard</xsl:text>
									<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
									<xsl:text>\itap</xsl:text>
										...
										<xsl:for-each select="n1:ObjectDetails">
											<xsl:for-each select="n1:Object[@Status = &apos;Modified&apos;]">
												<xsl:variable name="altova:RowStyle14">
													<xsl:text>\trrh0</xsl:text>
													<xsl:variable name="altova:CurrGridPos_Tbl6" select="$altova:nTableIndentTw_6"/>
													<xsl:text>\clvertalc\clcbpat142\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrl\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
													<xsl:if test="$altova:nColumnWidthTw_6_0 = $altova:nDefaultColumnWidthTw_6">
														<xsl:text>\clftsWidth1</xsl:text>
													</xsl:if>
													<xsl:text>\cellx</xsl:text>
													...
													<xsl:choose>
														<xsl:when test="count( n1:PropertyDetails ) &gt;0">
															<xsl:variable name="altova:RowStyle15">
																<xsl:text>\trrh0</xsl:text>
																<xsl:variable name="altova:CurrGridPos_Tbl6" select="$altova:nTableIndentTw_6"/>
																<xsl:text>\clvertalc\clmgf\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrl\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
																<xsl:if test="$altova:nColumnWidthTw_6_0 = $altova:nDefaultColumnWidthTw_6">
																	<xsl:text>\clftsWidth1</xsl:text>
																</xsl:if>
																<xsl:text>\cellx</xsl:text>
																<xsl:variable name="altova:CurrGridPos_Tbl6_Col0_AfterColumn" select="$altova:CurrGridPos_Tbl6 + $altova:nColumnWidthTw_6_0"/>
																<xsl:value-of select="ceiling($altova:CurrGridPos_Tbl6_Col0_AfterColumn)"/>
																<xsl:text>\clvertalc\clmrg\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
																<xsl:if test="$altova:nColumnWidthTw_6_1 = $altova:nDefaultColumnWidthTw_6">
																	<xsl:text>\clftsWidth1</xsl:text>
																</xsl:if>
																<xsl:text>\cellx</xsl:text>
															...
															<xsl:variable name="altova:nTableWidthIn_7" select="$altova:nColumnWidthTw_6_0 div 1440 * 1.00000 + $altova:nColumnWidthTw_6_1 div 1440 * 1.00000 + $altova:nColumnWidthTw_6_2 div 1440 * 1.00000 + $altova:nColumnWidthTw_6_3 div 1440 * 1.00000 - 0.02000 - 0.02000 - 0.03125 - 0.03125"/>
															...
															<xsl:variable name="altova:nSumColumnWidthsTw_7" select="round(9071.87)"/>
															...
															<xsl:variable name="altova:nColumnWidthTw_7_1" select="round(5.12 * 1440 * $altova:TableWidthFactor_7)"/>
															<xsl:text>\pard</xsl:text>
															<xsl:if test="$templatetablelevel + 2 &gt; 0">\intbl</xsl:if>
															<xsl:text>\itap</xsl:text>
															<xsl:value-of select="$templatetablelevel + 2"/>
															...
															<xsl:variable name="altova:nTableWidthIn_8">
																<xsl:choose>
																	<xsl:when test="4.72441 &gt; $altova:nColumnWidthTw_7_1">
																		<xsl:value-of select="$altova:nColumnWidthTw_7_1"/>
																	</xsl:when>
																	<xsl:otherwise>
																		<xsl:value-of select="4.72441"/>
																	</xsl:otherwise>
															...
															<xsl:variable name="altova:nSumColumnWidthsTw_8" select="round(6804.65)"/>
															...
															<xsl:variable name="altova:nColumnWidthTw_8_0" select="round(1.57 * 1440 * $altova:TableWidthFactor_8)"/>
															<xsl:variable name="altova:nColumnWidthTw_8_1" select="round(1.57 * 1440 * $altova:TableWidthFactor_8)"/>
															<xsl:variable name="altova:nColumnWidthTw_8_2" select="round(1.57 * 1440 * $altova:TableWidthFactor_8)"/>
															...
															<xsl:for-each select="n1:PropertyDetails">
																<xsl:variable name="altova:RowStyle17">
																	...
																	<xsl:text>\clvertalc\clbrdrt\brdrdot\brdrcf1\brdrw28\clbrdrb\brdrdot\brdrcf1\brdrw28\clbrdrl\brdrdot\brdrcf1\brdrw28\clbrdrr\brdrdot\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
																	...
																	<xsl:text>\clvertalc\clbrdrt\brdrdot\brdrcf1\brdrw28\clbrdrb\brdrdot\brdrcf1\brdrw28\clbrdrr\brdrdot\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
								...
								<xsl:if test="count(//n1:Object[@Status=&apos;New&apos;]) &gt; 0">
									...
									<xsl:variable name="altova:nSumColumnWidthsTw_9" select="round(9639.80)"/>
									...
									<xsl:variable name="altova:nColumnWidthTw_9_0" select="round(2.36 * 1440 * $altova:TableWidthFactor_9)"/>
									<xsl:variable name="altova:nColumnWidthTw_9_1" select="round(2.36 * 1440 * $altova:TableWidthFactor_9)"/>
									<xsl:variable name="altova:nColumnWidthTw_9_2" select="round(1.18 * 1440 * $altova:TableWidthFactor_9)"/>
									<xsl:variable name="altova:nColumnWidthTw_9_3" select="round(0.79 * 1440 * $altova:TableWidthFactor_9)"/>
									<xsl:text>\par </xsl:text>
									<xsl:text>\pard</xsl:text>
									<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
									<xsl:text>\itap</xsl:text>
								...
								<xsl:if test="count(//n1:Object[@Status=&apos;Deleted&apos;]) &gt; 0">
									...
									<xsl:variable name="altova:nSumColumnWidthsTw_10" select="round(9639.80)"/>
									...
									<xsl:variable name="altova:nColumnWidthTw_10_0" select="round(2.36 * 1440 * $altova:TableWidthFactor_10)"/>
									<xsl:variable name="altova:nColumnWidthTw_10_1" select="round(2.36 * 1440 * $altova:TableWidthFactor_10)"/>
									<xsl:variable name="altova:nColumnWidthTw_10_2" select="round(1.18 * 1440 * $altova:TableWidthFactor_10)"/>
									<xsl:variable name="altova:nColumnWidthTw_10_3" select="round(0.79 * 1440 * $altova:TableWidthFactor_10)"/>
									<xsl:text>\par </xsl:text>
									<xsl:text>\pard</xsl:text>
									<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
									<xsl:text>\itap</xsl:text>
					...
					<xsl:otherwise>
						...
						<xsl:choose>
							<xsl:when test="n1:IsDMDImport = &apos;Y&apos;">
								...
								<xsl:variable name="altova:nSumColumnWidthsTw_11" select="round(9640.29)"/>
								...
								<xsl:variable name="altova:nColumnWidthTw_11_0" select="round(1.57 * 1440 * $altova:TableWidthFactor_11)"/>
								<xsl:variable name="altova:nColumnWidthTw_11_1" select="round(1.57 * 1440 * $altova:TableWidthFactor_11)"/>
								<xsl:variable name="altova:nColumnWidthTw_11_2" select="round(1.57 * 1440 * $altova:TableWidthFactor_11)"/>
								<xsl:variable name="altova:nColumnWidthTw_11_3" select="round(1.18 * 1440 * $altova:TableWidthFactor_11)"/>
											...
											<xsl:for-each select="n1:PropertiesCollection">
												<xsl:choose>
													<xsl:when test="count( n1:PropertyDetails ) &gt;0">
														...
														<xsl:variable name="altova:nTableWidthIn_12" select="$altova:nColumnWidthTw_11_1 div 1440 * 1.00000 + $altova:nColumnWidthTw_11_2 div 1440 * 1.00000 + $altova:nColumnWidthTw_11_3 div 1440 * 1.00000 + $altova:nColumnWidthTw_11_4 div 1440 * 1.00000 - 0.02000 - 0.03125 - 0.03125"/>
														...
														<xsl:variable name="altova:nSumColumnWidthsTw_12" select="round(9071.87)"/>
														...
														<xsl:variable name="altova:nColumnWidthTw_12_1" select="round(5.12 * 1440 * $altova:TableWidthFactor_12)"/>
														<xsl:text>\pard</xsl:text>
														<xsl:if test="$templatetablelevel + 2 &gt; 0">\intbl</xsl:if>
														<xsl:text>\itap</xsl:text>
														<xsl:value-of select="$templatetablelevel + 2"/>
														...
														<xsl:variable name="altova:nTableWidthIn_13">
															<xsl:choose>
																<xsl:when test="4.72441 &gt; $altova:nColumnWidthTw_12_1">
																	<xsl:value-of select="$altova:nColumnWidthTw_12_1"/>
																</xsl:when>
																<xsl:otherwise>
																	<xsl:value-of select="4.72441"/>
																</xsl:otherwise>
														...
														<xsl:variable name="altova:nSumColumnWidthsTw_13" select="round(6804.65)"/>
														...
														<xsl:variable name="altova:nColumnWidthTw_13_0" select="round(1.57 * 1440 * $altova:TableWidthFactor_13)"/>
														<xsl:variable name="altova:nColumnWidthTw_13_1" select="round(1.57 * 1440 * $altova:TableWidthFactor_13)"/>
														<xsl:variable name="altova:nColumnWidthTw_13_2" select="round(1.57 * 1440 * $altova:TableWidthFactor_13)"/>
														<xsl:text>\pard</xsl:text>
														<xsl:if test="$templatetablelevel + 3 &gt; 0">\intbl</xsl:if>
														<xsl:text>\itap</xsl:text>
														<xsl:value-of select="$templatetablelevel + 3"/>
							...
							<xsl:otherwise>
								...
								<xsl:variable name="altova:nSumColumnWidthsTw_14" select="round(9639.80)"/>
								...
								<xsl:variable name="altova:nColumnWidthTw_14_0" select="round(2.36 * 1440 * $altova:TableWidthFactor_14)"/>
								<xsl:variable name="altova:nColumnWidthTw_14_1" select="round(2.36 * 1440 * $altova:TableWidthFactor_14)"/>
								<xsl:variable name="altova:nColumnWidthTw_14_2" select="round(1.18 * 1440 * $altova:TableWidthFactor_14)"/>
											...
											<xsl:for-each select="n1:PropertiesCollection">
												<xsl:choose>
													<xsl:when test="count( n1:PropertyDetails ) &gt;0">
														...
														<xsl:variable name="altova:nTableWidthIn_15" select="$altova:nColumnWidthTw_14_0 div 1440 * 1.00000 + $altova:nColumnWidthTw_14_1 div 1440 * 1.00000 + $altova:nColumnWidthTw_14_2 div 1440 * 1.00000 + $altova:nColumnWidthTw_14_3 div 1440 * 1.00000 - 0.02000 - 0.02000 - 0.03125 - 0.03125"/>
														...
														<xsl:variable name="altova:nSumColumnWidthsTw_15" select="round(9071.87)"/>
														...
														<xsl:variable name="altova:nColumnWidthTw_15_0" select="round(1.18 * 1440 * $altova:TableWidthFactor_15)"/>
														<xsl:variable name="altova:nColumnWidthTw_15_1" select="round(5.12 * 1440 * $altova:TableWidthFactor_15)"/>
														<xsl:text>\pard</xsl:text>
														<xsl:if test="$templatetablelevel + 2 &gt; 0">\intbl</xsl:if>
														<xsl:text>\itap</xsl:text>
														<xsl:value-of select="$templatetablelevel + 2"/>
														...
														<xsl:variable name="altova:nTableWidthIn_16">
															<xsl:choose>
																<xsl:when test="4.72441 &gt; $altova:nColumnWidthTw_15_1">
																	<xsl:value-of select="$altova:nColumnWidthTw_15_1"/>
																</xsl:when>
																<xsl:otherwise>
																	<xsl:value-of select="4.72441"/>
																</xsl:otherwise>
														...
														<xsl:variable name="altova:nSumColumnWidthsTw_16" select="round(6804.65)"/>
														...
														<xsl:variable name="altova:nColumnWidthTw_16_0" select="round(1.57 * 1440 * $altova:TableWidthFactor_16)"/>
														<xsl:variable name="altova:nColumnWidthTw_16_1" select="round(1.57 * 1440 * $altova:TableWidthFactor_16)"/>
														<xsl:variable name="altova:nColumnWidthTw_16_2" select="round(1.57 * 1440 * $altova:TableWidthFactor_16)"/>
														<xsl:text>\pard\fs24</xsl:text>
														<xsl:if test="$templatetablelevel + 3 &gt; 0">\intbl</xsl:if>
														<xsl:text>\itap</xsl:text>
														<xsl:value-of select="$templatetablelevel + 3"/>
