...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_ad" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="altova altovaext clitype fn iso4217 ix java link n1 sps xbrldi xbrli xlink xs xsd xsi">
			...
			<xsl:for-each select="n1:root">
				...
				<xsl:for-each select="n1:DomainsCollection">
					<xsl:for-each select="n1:DomainDetails">
						...
						<xsl:call-template name="write-text">
							<xsl:with-param name="text">
								<xsl:value-of select="translate(string(n1:DomainName), ' ', '_')"/>
							</xsl:with-param>
						</xsl:call-template>
						<xsl:text>}</xsl:text>
						<xsl:choose>
								...
								<xsl:for-each select="n1:ConstraintDetails">
									...
									<xsl:if test="count( n1:RangesCollection )">
										...
										<xsl:variable name="altova:nTableWidthIn_3">
											<xsl:choose>
												<xsl:when test="9.64567 &gt; $altova:nColumnWidthTw_2_0 - 0.02000 - 0.02000 - 0.03125 - 0.03125">
													<xsl:value-of select="$altova:nColumnWidthTw_2_0 - 0.02000 - 0.02000 - 0.03125 - 0.03125"/>
												</xsl:when>
												<xsl:otherwise>
													<xsl:value-of select="9.64567"/>
												</xsl:otherwise>
											</xsl:choose>
										</xsl:variable>
										...
										<xsl:variable name="altova:nSumColumnWidthsTw_3" select="round(13891.26)"/>
										...
										<xsl:variable name="altova:nColumnWidthTw_3_0" select="round(1.18 * 1440 * $altova:TableWidthFactor_3)"/>
										<xsl:variable name="altova:nColumnWidthTw_3_1" select="round(1.18 * 1440 * $altova:TableWidthFactor_3)"/>
										<xsl:variable name="altova:nColumnWidthTw_3_2" select="round(7.28 * 1440 * $altova:TableWidthFactor_3)"/>
									...
									<xsl:if test="count( n1:ValueListsCollection ) != 0">
										...
										<xsl:variable name="altova:nSumColumnWidthsTw_4" select="round(13890.76)"/>
										...
										<xsl:variable name="altova:nColumnWidthTw_4_0" select="round(1.18 * 1440 * $altova:TableWidthFactor_4)"/>
										<xsl:variable name="altova:nColumnWidthTw_4_1" select="round(8.46 * 1440 * $altova:TableWidthFactor_4)"/>
										<xsl:text>\pard\fs24</xsl:text>
										<xsl:if test="$templatetablelevel + 2 &gt; 0">\intbl</xsl:if>
										<xsl:text>\itap</xsl:text>
										<xsl:value-of select="$templatetablelevel + 2"/>
									...
									<xsl:if test="count( n1:CheckConstraintsCollection ) != 0">
										...
										<xsl:variable name="altova:nSumColumnWidthsTw_5" select="round(13890.76)"/>
										...
										<xsl:variable name="altova:nColumnWidthTw_5_0" select="round(8.46 * 1440 * $altova:TableWidthFactor_5)"/>
						...
						<xsl:if test="count( n1:TablesCollection )">
							...
							<xsl:variable name="altova:nColumnWidthTw_6_1" select="round(3.35 * 1440 * $altova:TableWidthFactor_6)"/>
							<xsl:variable name="altova:nColumnWidthTw_6_2" select="round(3.35 * 1440 * $altova:TableWidthFactor_6)"/>
							<xsl:text>\par </xsl:text>
							<xsl:text>\pard</xsl:text>
							<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
							<xsl:text>\itap</xsl:text>
						...
						<xsl:if test="count( n1:EntitiesCollection)">
							...
							<xsl:variable name="altova:nSumColumnWidthsTw_7" select="round(14174.23)"/>
							...
							<xsl:variable name="altova:nColumnWidthTw_7_0" select="round(4.92 * 1440 * $altova:TableWidthFactor_7)"/>
							<xsl:variable name="altova:nColumnWidthTw_7_1" select="round(4.92 * 1440 * $altova:TableWidthFactor_7)"/>
							<xsl:text>\par </xsl:text>
							<xsl:text>\pard</xsl:text>
							<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
							<xsl:text>\itap</xsl:text>
	...
	<xsl:template name="altova:Section_0_FooterRight">
		...
		<xsl:variable name="altova:nSumColumnWidthsTw_8" select="round(14174.23)"/>
		...
		<xsl:variable name="altova:nColumnWidthTw_8_0" select="round(7.09 * 1440 * $altova:TableWidthFactor_8)"/>
		<xsl:variable name="altova:nColumnWidthTw_8_1" select="round(2.76 * 1440 * $altova:TableWidthFactor_8)"/>
		<xsl:text>\pard</xsl:text>
		<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
		<xsl:text>\itap</xsl:text>
		<xsl:value-of select="$templatetablelevel + 1"/>
	...
	<xsl:template name="altova:Section_0_FooterLeft">
		...
		<xsl:variable name="altova:nColumnWidthTw_9_0" select="round(7.09 * 1440 * $altova:TableWidthFactor_9)"/>
		<xsl:variable name="altova:nColumnWidthTw_9_1" select="round(2.76 * 1440 * $altova:TableWidthFactor_9)"/>
		<xsl:text>\pard</xsl:text>
		<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
		<xsl:text>\itap</xsl:text>
		<xsl:value-of select="$templatetablelevel + 1"/>
