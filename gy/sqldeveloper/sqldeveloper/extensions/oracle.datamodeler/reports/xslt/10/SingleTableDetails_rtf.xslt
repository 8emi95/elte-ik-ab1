		...
		<xsl:for-each select="$XML">
			<xsl:for-each select="n1:root">
				...
				<xsl:if test="count( n1:ColumnsCollection )">
					...
					<xsl:variable name="altova:nSumColumnWidthsTw_5" select="round(14178.73)"/>
					...
					<xsl:variable name="altova:nColumnWidthTw_5_1" select="round(1.97 * 1440 * $altova:TableWidthFactor_5)"/>
					<xsl:variable name="altova:nColumnWidthTw_5_2" select="round(0.31 * 1440 * $altova:TableWidthFactor_5)"/>
					<xsl:variable name="altova:nColumnWidthTw_5_3" select="round(0.31 * 1440 * $altova:TableWidthFactor_5)"/>
					<xsl:variable name="altova:nColumnWidthTw_5_4" select="round(0.31 * 1440 * $altova:TableWidthFactor_5)"/>
					<xsl:variable name="altova:nColumnWidthTw_5_5" select="round(1.57 * 1440 * $altova:TableWidthFactor_5)"/>
					<xsl:variable name="altova:nColumnWidthTw_5_6" select="round(0.39 * 1440 * $altova:TableWidthFactor_5)"/>
					<xsl:variable name="altova:nColumnWidthTw_5_7" select="round(1.14 * 1440 * $altova:TableWidthFactor_5)"/>
					<xsl:variable name="altova:nColumnWidthTw_5_8" select="round(1.14 * 1440 * $altova:TableWidthFactor_5)"/>
					<xsl:variable name="altova:nColumnWidthTw_5_9" select="round(1.14 * 1440 * $altova:TableWidthFactor_5)"/>
					<xsl:variable name="altova:nColumnWidthTw_5_10" select="round(1.14 * 1440 * $altova:TableWidthFactor_5)"/>
					<xsl:text>\par </xsl:text>
					<xsl:text>\pard</xsl:text>
					<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
					<xsl:text>\itap</xsl:text>
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:M">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_5_4 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:DataType">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_5_5 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:DataTypeKind">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_5_6 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:DomainName">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_5_7 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:Formula">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_5_8 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:Security">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_5_9 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:PreferredAbbreviation">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_5_10 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
				...
				<xsl:if test="count( n1:ColumnsCommentsCollection )">
					...
					<xsl:variable name="altova:nSumColumnWidthsTw_6" select="round(14175.23)"/>
					...
					<xsl:variable name="altova:nColumnWidthTw_6_2" select="round(3.54 * 1440 * $altova:TableWidthFactor_6)"/>
					<xsl:variable name="altova:nColumnWidthTw_6_3" select="round(3.54 * 1440 * $altova:TableWidthFactor_6)"/>
					<xsl:text>\par </xsl:text>
					<xsl:text>\pard</xsl:text>
					<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
					<xsl:text>\itap</xsl:text>
				...
				<xsl:if test="count( n1:IndexesCollection )">
					...
					<xsl:variable name="altova:nSumColumnWidthsTw_7" select="round(14176.73)"/>
					...
					<xsl:variable name="altova:nColumnWidthTw_7_0" select="round(2.76 * 1440 * $altova:TableWidthFactor_7)"/>
					<xsl:variable name="altova:nColumnWidthTw_7_1" select="round(0.59 * 1440 * $altova:TableWidthFactor_7)"/>
					<xsl:variable name="altova:nColumnWidthTw_7_2" select="round(0.79 * 1440 * $altova:TableWidthFactor_7)"/>
					<xsl:variable name="altova:nColumnWidthTw_7_3" select="round(0.59 * 1440 * $altova:TableWidthFactor_7)"/>
					<xsl:variable name="altova:nColumnWidthTw_7_4" select="round(2.17 * 1440 * $altova:TableWidthFactor_7)"/>
					<xsl:variable name="altova:nColumnWidthTw_7_5" select="round(2.36 * 1440 * $altova:TableWidthFactor_7)"/>
					<xsl:variable name="altova:nColumnWidthTw_7_6" select="round(0.59 * 1440 * $altova:TableWidthFactor_7)"/>
					<xsl:text>\par </xsl:text>
					<xsl:text>\pard</xsl:text>
					<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
					<xsl:text>\itap</xsl:text>
				...
				<xsl:if test="count( n1:ConstraintsCollection )">
					...
					<xsl:variable name="altova:nSumColumnWidthsTw_8" select="round(14174.73)"/>
					...
					<xsl:variable name="altova:nColumnWidthTw_8_2" select="round(7.48 * 1440 * $altova:TableWidthFactor_8)"/>
					<xsl:text>\par </xsl:text>
					<xsl:text>\pard</xsl:text>
					<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
					<xsl:text>\itap</xsl:text>
							...
							<xsl:for-each select="n1:ConstraintDetails">
								...
								<xsl:if test="count( n1:RangesCollection ) != 0">
									...
									<xsl:variable name="altova:nTableWidthIn_9">
										<xsl:choose>
											<xsl:when test="7.28346 &gt; $altova:nColumnWidthTw_8_2 - 0.02000 - 0.03125 - 0.03125">
												<xsl:value-of select="$altova:nColumnWidthTw_8_2 - 0.02000 - 0.03125 - 0.03125"/>
											</xsl:when>
											<xsl:otherwise>
									...
									<xsl:variable name="altova:nSumColumnWidthsTw_9" select="round(10489.69)"/>
									...
									<xsl:variable name="altova:nColumnWidthTw_9_2" select="round(4.92 * 1440 * $altova:TableWidthFactor_9)"/>
								...
								<xsl:if test="count( n1:ValueListsCollection ) != 0">
									...
									<xsl:variable name="altova:nColumnWidthTw_10_1" select="round(6.10 * 1440 * $altova:TableWidthFactor_10)"/>
									<xsl:text>\pard\fs24</xsl:text>
									<xsl:if test="$templatetablelevel + 2 &gt; 0">\intbl</xsl:if>
									<xsl:text>\itap</xsl:text>
									<xsl:value-of select="$templatetablelevel + 2"/>
								...
								<xsl:if test="count( n1:CheckConstraintsCollection ) != 0">
									...
									<xsl:variable name="altova:nColumnWidthTw_11_0" select="round(6.10 * 1440 * $altova:TableWidthFactor_11)"/>
