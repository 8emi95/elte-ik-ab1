...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_a_st" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="altova altovaext clitype fn iso4217 ix java link n1 sps xbrldi xbrli xlink xs xsd xsi">
			...
			<xsl:for-each select="n1:root">
				...
				<xsl:for-each select="n1:STCollection">
					<xsl:for-each select="n1:STDetails">
						...
						<xsl:call-template name="write-text">
							<xsl:with-param name="text">
								<xsl:value-of select="translate(string(n1:STName), ' ', '_')"/>
							</xsl:with-param>
						</xsl:call-template>
						<xsl:text>}</xsl:text>
						<xsl:choose>
						...
						<xsl:if test="count( n1:AttributesCollection)">
							...
							<xsl:variable name="altova:nSumColumnWidthsTw_4" select="round(14176.23)"/>
							...
							<xsl:variable name="altova:nColumnWidthTw_4_1" select="round(5.91 * 1440 * $altova:TableWidthFactor_4)"/>
							<xsl:variable name="altova:nColumnWidthTw_4_2" select="round(0.39 * 1440 * $altova:TableWidthFactor_4)"/>
							<xsl:variable name="altova:nColumnWidthTw_4_3" select="round(1.57 * 1440 * $altova:TableWidthFactor_4)"/>
							<xsl:variable name="altova:nColumnWidthTw_4_4" select="round(0.39 * 1440 * $altova:TableWidthFactor_4)"/>
							<xsl:variable name="altova:nColumnWidthTw_4_5" select="round(1.18 * 1440 * $altova:TableWidthFactor_4)"/>
							<xsl:text>\par </xsl:text>
							<xsl:text>\pard</xsl:text>
							<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
							<xsl:text>\itap</xsl:text>
						...
						<xsl:if test="count( n1:MethodsCollection )">
							...
							<xsl:variable name="altova:nColumnWidthTw_6_2" select="round(0.39 * 1440 * $altova:TableWidthFactor_6)"/>
							<xsl:variable name="altova:nColumnWidthTw_6_3" select="round(0.39 * 1440 * $altova:TableWidthFactor_6)"/>
							<xsl:variable name="altova:nColumnWidthTw_6_4" select="round(1.97 * 1440 * $altova:TableWidthFactor_6)"/>
							<xsl:variable name="altova:nColumnWidthTw_6_5" select="round(1.97 * 1440 * $altova:TableWidthFactor_6)"/>
							<xsl:variable name="altova:nColumnWidthTw_6_6" select="round(2.76 * 1440 * $altova:TableWidthFactor_6)"/>
							<xsl:text>\par </xsl:text>
							<xsl:text>\pard</xsl:text>
							<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
							<xsl:text>\itap</xsl:text>
								...
								<xsl:for-each select="n1:MethodDetails">
									...
									<xsl:choose>
										<xsl:when test="count(n1:MethodParametersCollection )">
											...
											<xsl:variable name="altova:nTableWidthIn_7" select="$altova:nColumnWidthTw_6_6 div 1440 * 1.00000 - 0.02000 - 0.03125 - 0.03125"/>
											...
											<xsl:variable name="altova:nSumColumnWidthsTw_7" select="round(3742.73)"/>
											...
											<xsl:variable name="altova:nColumnWidthTw_7_0" select="round(1.30 * 1440 * $altova:TableWidthFactor_7)"/>
											<xsl:variable name="altova:nColumnWidthTw_7_1" select="round(1.30 * 1440 * $altova:TableWidthFactor_7)"/>
											...
											<xsl:text>\pard\qc\sl0\fs16</xsl:text>
											<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
											<xsl:text>\itap</xsl:text>
											<xsl:value-of select="$templatetablelevel + 1"/>
											<xsl:text> </xsl:text>
						...
						<xsl:if test="count( n1:TablesCollection )">
							...
							<xsl:variable name="altova:nColumnWidthTw_8_0" select="round(3.15 * 1440 * $altova:TableWidthFactor_8)"/>
							<xsl:variable name="altova:nColumnWidthTw_8_1" select="round(3.35 * 1440 * $altova:TableWidthFactor_8)"/>
							<xsl:variable name="altova:nColumnWidthTw_8_2" select="round(3.35 * 1440 * $altova:TableWidthFactor_8)"/>
							<xsl:text>\par </xsl:text>
							<xsl:text>\pard</xsl:text>
							<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
							<xsl:text>\itap</xsl:text>
						...
						<xsl:if test="count( n1:EntitiesCollection)">
							...
							<xsl:variable name="altova:nSumColumnWidthsTw_9" select="round(14174.23)"/>
							...
							<xsl:variable name="altova:nColumnWidthTw_9_0" select="round(4.92 * 1440 * $altova:TableWidthFactor_9)"/>
							<xsl:variable name="altova:nColumnWidthTw_9_1" select="round(4.92 * 1440 * $altova:TableWidthFactor_9)"/>
							<xsl:text>\par </xsl:text>
							<xsl:text>\pard</xsl:text>
							<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
							<xsl:text>\itap</xsl:text>
	...
	<xsl:template name="altova:Section_0_FooterRight">
		...
		<xsl:variable name="altova:nSumColumnWidthsTw_10" select="round(14174.23)"/>
		...
		<xsl:variable name="altova:nColumnWidthTw_10_0" select="round(7.09 * 1440 * $altova:TableWidthFactor_10)"/>
		<xsl:variable name="altova:nColumnWidthTw_10_1" select="round(2.76 * 1440 * $altova:TableWidthFactor_10)"/>
		<xsl:text>\pard</xsl:text>
		<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
		<xsl:text>\itap</xsl:text>
		<xsl:value-of select="$templatetablelevel + 1"/>
	...
	<xsl:template name="altova:Section_0_FooterLeft">
		...
		<xsl:variable name="altova:nSumColumnWidthsTw_11" select="round(14174.23)"/>
		...
		<xsl:variable name="altova:nColumnWidthTw_11_0" select="round(7.09 * 1440 * $altova:TableWidthFactor_11)"/>
		<xsl:variable name="altova:nColumnWidthTw_11_1" select="round(2.76 * 1440 * $altova:TableWidthFactor_11)"/>
		<xsl:text>\pard</xsl:text>
		<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
		<xsl:text>\itap</xsl:text>
		<xsl:value-of select="$templatetablelevel + 1"/>
