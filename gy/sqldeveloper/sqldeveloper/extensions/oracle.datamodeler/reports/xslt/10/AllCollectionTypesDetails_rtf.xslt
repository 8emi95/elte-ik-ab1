...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_a_ct" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="altova altovaext clitype fn iso4217 ix java link n1 sps xbrldi xbrli xlink xs xsd xsi">
			...
			<xsl:for-each select="n1:root">
				...
				<xsl:for-each select="n1:CTCollection">
					<xsl:for-each select="n1:CTDetails">
						...
						<xsl:call-template name="write-text">
							<xsl:with-param name="text">
								<xsl:value-of select="translate(string(n1:CTName), ' ', '_')"/>
							</xsl:with-param>
						</xsl:call-template>
						<xsl:text>}</xsl:text>
						<xsl:choose>
						...
						<xsl:if test="count( n1:TablesCollection )">
							...
							<xsl:variable name="altova:nColumnWidthTw_3_1" select="round(3.35 * 1440 * $altova:TableWidthFactor_3)"/>
							<xsl:variable name="altova:nColumnWidthTw_3_2" select="round(3.35 * 1440 * $altova:TableWidthFactor_3)"/>
							<xsl:text>\par </xsl:text>
							<xsl:text>\pard</xsl:text>
							<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
							<xsl:text>\itap</xsl:text>
						...
						<xsl:if test="count( n1:EntitiesCollection )">
							...
							<xsl:variable name="altova:nSumColumnWidthsTw_4" select="round(14174.23)"/>
							...
							<xsl:variable name="altova:nColumnWidthTw_4_0" select="round(4.92 * 1440 * $altova:TableWidthFactor_4)"/>
							<xsl:variable name="altova:nColumnWidthTw_4_1" select="round(4.92 * 1440 * $altova:TableWidthFactor_4)"/>
							<xsl:text>\par </xsl:text>
							<xsl:text>\pard</xsl:text>
							<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
							<xsl:text>\itap</xsl:text>
	...
	<xsl:template name="altova:Section_0_FooterRight">
		...
		<xsl:variable name="altova:nSumColumnWidthsTw_5" select="round(14174.23)"/>
		...
		<xsl:variable name="altova:nColumnWidthTw_5_0" select="round(7.09 * 1440 * $altova:TableWidthFactor_5)"/>
		<xsl:variable name="altova:nColumnWidthTw_5_1" select="round(2.76 * 1440 * $altova:TableWidthFactor_5)"/>
		<xsl:text>\pard</xsl:text>
		<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
		<xsl:text>\itap</xsl:text>
		<xsl:value-of select="$templatetablelevel + 1"/>
	...
	<xsl:template name="altova:Section_0_FooterLeft">
		...
		<xsl:variable name="altova:nSumColumnWidthsTw_6" select="round(14174.23)"/>
		...
		<xsl:variable name="altova:nColumnWidthTw_6_0" select="round(7.09 * 1440 * $altova:TableWidthFactor_6)"/>
		<xsl:variable name="altova:nColumnWidthTw_6_1" select="round(2.76 * 1440 * $altova:TableWidthFactor_6)"/>
		<xsl:text>\pard</xsl:text>
		<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
		<xsl:text>\itap</xsl:text>
		<xsl:value-of select="$templatetablelevel + 1"/>
