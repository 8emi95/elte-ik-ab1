...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_ae" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="altova altovaext clitype fn iso4217 ix java link n1 sps xbrldi xbrli xlink xs xsd xsi">
		...
		<xsl:for-each select="$XML">
			<xsl:for-each select="n1:root">
				...
				<xsl:variable name="tablestyle0">
					...
					<xsl:text>\trpaddt45\trpaddl45\trpaddb45\trpaddr45\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
				</xsl:variable>
				...
				<xsl:if test="count(n1:SubViewsCollection)">
					...
					<xsl:variable name="altova:nSumColumnWidthsTw_1" select="round(14175.23)"/>
					...
					<xsl:variable name="altova:nColumnWidthTw_1_1" select="round(2.95 * 1440 * $altova:TableWidthFactor_1)"/>
					<xsl:variable name="altova:nColumnWidthTw_1_2" select="round(2.95 * 1440 * $altova:TableWidthFactor_1)"/>
					<xsl:variable name="altova:nColumnWidthTw_1_3" select="round(2.36 * 1440 * $altova:TableWidthFactor_1)"/>
					<xsl:text>\pard</xsl:text>
					<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
					<xsl:text>\itap</xsl:text>
					<xsl:value-of select="$templatetablelevel + 1"/>
					...
					<xsl:for-each select="n1:SubViewsCollection">
						<xsl:for-each select="n1:SubViewsDetails">
							...
							<xsl:for-each select="n1:SWName">
								...
								<xsl:text>" }}{\fldrslt{\ul\cf5 </xsl:text>
								<xsl:call-template name="write-text">
									<xsl:with-param name="text">
										...
										<xsl:for-each select="n1:SWNotes">
											<xsl:for-each select="n1:SWNotesDetails">
												<xsl:for-each select="n1:SWNoteRow">
													<xsl:apply-templates>
														<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_1_2 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
														<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
													</xsl:apply-templates>
													<xsl:text>\par </xsl:text>
												</xsl:for-each>
								...
								<xsl:for-each select="n1:SWObject">
									<xsl:choose>
										...
										<xsl:when test="substring(string(concat(&apos;#&apos;,.)), 1, 1) = '#'">
											...
											<xsl:call-template name="write-text">
												<xsl:with-param name="text">
													<xsl:value-of select="translate(substring(concat(&apos;#&apos;,.), 2), ' ', '_')"/>
												</xsl:with-param>
											</xsl:call-template>
										</xsl:when>
										<xsl:otherwise>
											<xsl:text>{\field{\*\fldinst{ HYPERLINK "</xsl:text>
											<xsl:if test="substring( concat(&apos;#&apos;,.), 2, 1) = ':'">
												<xsl:text>file:///</xsl:text>
											</xsl:if>
											<xsl:call-template name="write-text">
												<xsl:with-param name="text">
									...
									<xsl:text>" }}{\fldrslt{\ul\cf5 </xsl:text>
									<xsl:apply-templates>
										<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_1_3 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
										<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
									</xsl:apply-templates>
									<xsl:text>\par </xsl:text>
									<xsl:text>}}}</xsl:text>
				...
				<xsl:for-each select="n1:EntitiesCollection">
					<xsl:for-each select="n1:EntityDetails">
						...
						<xsl:variable name="altova:nSumColumnWidthsTw_2" select="round(13607.80)"/>
						...
						<xsl:variable name="altova:nColumnWidthTw_2_0" select="round(5.91 * 1440 * $altova:TableWidthFactor_2)"/>
						<xsl:variable name="altova:nColumnWidthTw_2_1" select="round(0.39 * 1440 * $altova:TableWidthFactor_2)"/>
						<xsl:variable name="altova:nColumnWidthTw_2_2" select="round(3.15 * 1440 * $altova:TableWidthFactor_2)"/>
						<xsl:text>\par </xsl:text>
						<xsl:text>\pard</xsl:text>
						<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
						<xsl:text>\itap</xsl:text>
						...
						<xsl:variable name="tablestyle2">
							...
							<xsl:text>\trpaddt0\trpaddl0\trpaddb0\trpaddr0\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
						</xsl:variable>
						...
						<xsl:variable name="altova:RowStyle6">
							...
							<xsl:text>\clvertalc\clpadl0\clpadfl3\clpadb0\clpadfb3\clpadt0\clpadft3\clpadr0\clpadfr3</xsl:text>
						...
						<xsl:variable name="altova:nTableWidthIn_3">
							<xsl:choose>
								<xsl:when test="5.90551 &gt; $altova:nColumnWidthTw_2_0">
									<xsl:value-of select="$altova:nColumnWidthTw_2_0"/>
								</xsl:when>
								<xsl:otherwise>
						...
						<xsl:variable name="altova:nSumColumnWidthsTw_3" select="round(8504.94)"/>
						...
						<xsl:variable name="altova:nColumnWidthTw_3_1" select="round(4.33 * 1440 * $altova:TableWidthFactor_3)"/>
						<xsl:text>\pard</xsl:text>
						...
						<xsl:call-template name="write-text">
							<xsl:with-param name="text">
								<xsl:value-of select="translate(string(n1:EntityName), ' ', '_')"/>
							</xsl:with-param>
						</xsl:call-template>
						<xsl:text>}</xsl:text>
						<xsl:choose>
						...
						<xsl:if test="count( n1:MappedTablesCollection )">
							...
							<xsl:variable name="altova:nTableWidthIn_4">
								<xsl:choose>
									<xsl:when test="3.14961 &gt; $altova:nColumnWidthTw_2_2">
										<xsl:value-of select="$altova:nColumnWidthTw_2_2"/>
									</xsl:when>
									<xsl:otherwise>
							...
							<xsl:variable name="altova:nSumColumnWidthsTw_4" select="round(4535.93)"/>
							...
							<xsl:variable name="altova:nColumnWidthTw_4_0" select="round(3.15 * 1440 * $altova:TableWidthFactor_4)"/>
						...
						<xsl:if test="count( n1:DescriptionNotes )">
							...
							<xsl:for-each select="n1:DescriptionNotes">
								...
								<xsl:variable name="altova:nSumColumnWidthsTw_5" select="round(11339.58)"/>
								...
								<xsl:variable name="altova:nColumnWidthTw_5_0" select="round(1.57 * 1440 * $altova:TableWidthFactor_5)"/>
								<xsl:variable name="altova:nColumnWidthTw_5_1" select="round(6.30 * 1440 * $altova:TableWidthFactor_5)"/>
								<xsl:text>\pard</xsl:text>
								<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
								<xsl:text>\itap</xsl:text>
								<xsl:value-of select="$templatetablelevel + 1"/>
						...
						<xsl:if test="count( n1:QuantitativeInfoCollection )">
							...
							<xsl:for-each select="n1:QuantitativeInfoCollection">
								...
								<xsl:variable name="altova:nSumColumnWidthsTw_6" select="round(4536.43)"/>
								...
								<xsl:variable name="altova:nColumnWidthTw_6_0" select="round(1.57 * 1440 * $altova:TableWidthFactor_6)"/>
								<xsl:variable name="altova:nColumnWidthTw_6_1" select="round(1.57 * 1440 * $altova:TableWidthFactor_6)"/>
								<xsl:text>\pard</xsl:text>
								<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
								<xsl:text>\itap</xsl:text>
								<xsl:value-of select="$templatetablelevel + 1"/>
						...
						<xsl:if test="count( n1:DiagramsCollection)">
							...
							<xsl:variable name="altova:nSumColumnWidthsTw_7" select="round(4535.93)"/>
							...
							<xsl:variable name="altova:nColumnWidthTw_7_0" select="round(3.15 * 1440 * $altova:TableWidthFactor_7)"/>
							<xsl:text>\pard</xsl:text>
							<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
							<xsl:text>\itap</xsl:text>
							<xsl:value-of select="$templatetablelevel + 1"/>
						...
						<xsl:if test="count( n1:AttributesCollection )">
							...
							<xsl:variable name="altova:nSumColumnWidthsTw_8" select="round(14178.73)"/>
							...
							<xsl:variable name="altova:nColumnWidthTw_8_0" select="round(0.39 * 1440 * $altova:TableWidthFactor_8)"/>
							<xsl:variable name="altova:nColumnWidthTw_8_1" select="round(1.97 * 1440 * $altova:TableWidthFactor_8)"/>
							<xsl:variable name="altova:nColumnWidthTw_8_2" select="round(0.31 * 1440 * $altova:TableWidthFactor_8)"/>
							<xsl:variable name="altova:nColumnWidthTw_8_3" select="round(0.31 * 1440 * $altova:TableWidthFactor_8)"/>
							<xsl:variable name="altova:nColumnWidthTw_8_4" select="round(0.31 * 1440 * $altova:TableWidthFactor_8)"/>
							<xsl:variable name="altova:nColumnWidthTw_8_5" select="round(1.57 * 1440 * $altova:TableWidthFactor_8)"/>
							<xsl:variable name="altova:nColumnWidthTw_8_6" select="round(0.39 * 1440 * $altova:TableWidthFactor_8)"/>
							<xsl:variable name="altova:nColumnWidthTw_8_7" select="round(1.14 * 1440 * $altova:TableWidthFactor_8)"/>
							<xsl:variable name="altova:nColumnWidthTw_8_8" select="round(1.14 * 1440 * $altova:TableWidthFactor_8)"/>
							<xsl:variable name="altova:nColumnWidthTw_8_9" select="round(1.14 * 1440 * $altova:TableWidthFactor_8)"/>
							<xsl:variable name="altova:nColumnWidthTw_8_10" select="round(1.14 * 1440 * $altova:TableWidthFactor_8)"/>
							<xsl:text>\par </xsl:text>
							<xsl:text>\pard</xsl:text>
							<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
							<xsl:text>\itap</xsl:text>
							...
							<xsl:variable name="altova:RowStyle25">
								...
								<xsl:text>\clvertalc\clcbpat141\clbrdrt\brdrs\brdrcf1\brdrw28\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
								<xsl:if test="$altova:nColumnWidthTw_8_9 = $altova:nDefaultColumnWidthTw_8">
									<xsl:text>\clftsWidth1</xsl:text>
								</xsl:if>
								<xsl:text>\cellx</xsl:text>
								<xsl:variable name="altova:CurrGridPos_Tbl8_Col9_AfterColumn" select="$altova:CurrGridPos_Tbl8_Col8_AfterColumn + $altova:nColumnWidthTw_8_9"/>
								<xsl:value-of select="ceiling($altova:CurrGridPos_Tbl8_Col9_AfterColumn)"/>
								<xsl:text>\clvertalc\clcbpat141\clbrdrt\brdrs\brdrcf1\brdrw28\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
								<xsl:if test="$altova:nColumnWidthTw_8_10 = $altova:nDefaultColumnWidthTw_8">
									<xsl:text>\clftsWidth1</xsl:text>
								</xsl:if>
								<xsl:text>\cellx</xsl:text>
								<xsl:variable name="altova:CurrGridPos_Tbl8_Col10_AfterColumn" select="$altova:CurrGridPos_Tbl8_Col9_AfterColumn + $altova:nColumnWidthTw_8_10"/>
								<xsl:value-of select="ceiling($altova:CurrGridPos_Tbl8_Col10_AfterColumn)"/>
							</xsl:variable>
							<xsl:if test="$templatetablelevel + 1 = 1">
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:FK">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_8_3 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:M">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_8_4 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:DataType">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_8_5 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:DataTypeKind">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_8_6 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:DomainName">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_8_7 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:Formula">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_8_8 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:PreferredAbbreviation">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_8_9 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:AttributeSynonyms">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_8_10 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
						...
						<xsl:if test="count( n1:AttributesCommentsCollection )">
							...
							<xsl:variable name="altova:nSumColumnWidthsTw_9" select="round(14175.23)"/>
							...
							<xsl:variable name="altova:nColumnWidthTw_9_0" select="round(0.39 * 1440 * $altova:TableWidthFactor_9)"/>
							<xsl:variable name="altova:nColumnWidthTw_9_1" select="round(2.36 * 1440 * $altova:TableWidthFactor_9)"/>
							<xsl:variable name="altova:nColumnWidthTw_9_2" select="round(3.54 * 1440 * $altova:TableWidthFactor_9)"/>
							<xsl:variable name="altova:nColumnWidthTw_9_3" select="round(3.54 * 1440 * $altova:TableWidthFactor_9)"/>
							<xsl:text>\par </xsl:text>
							<xsl:text>\pard</xsl:text>
							<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
							<xsl:text>\itap</xsl:text>
											...
											<xsl:for-each select="n1:AttributeDescription">
												<xsl:for-each select="n1:AttributeDescriptionDetails">
													<xsl:for-each select="n1:AttributeDescriptionRow">
														<xsl:apply-templates>
															<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_9_2 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
															<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
														</xsl:apply-templates>
														<xsl:text>\par </xsl:text>
													</xsl:for-each>
											...
											<xsl:for-each select="n1:AttributeNotes">
												<xsl:for-each select="n1:AttributeNotesDetails">
													<xsl:for-each select="n1:AttributeNoteRow">
														<xsl:apply-templates>
															<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_9_3 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
															<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
														</xsl:apply-templates>
														<xsl:text>\par </xsl:text>
													</xsl:for-each>
						...
						<xsl:if test="count( n1:ConstraintsCollection )">
							...
							<xsl:variable name="altova:nSumColumnWidthsTw_10" select="round(14174.73)"/>
							...
							<xsl:variable name="altova:nColumnWidthTw_10_0" select="round(1.18 * 1440 * $altova:TableWidthFactor_10)"/>
							<xsl:variable name="altova:nColumnWidthTw_10_1" select="round(1.18 * 1440 * $altova:TableWidthFactor_10)"/>
							<xsl:variable name="altova:nColumnWidthTw_10_2" select="round(7.48 * 1440 * $altova:TableWidthFactor_10)"/>
							<xsl:text>\par </xsl:text>
							<xsl:text>\pard</xsl:text>
							<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
							<xsl:text>\itap</xsl:text>
								...
								<xsl:for-each select="n1:ConstraintDetails">
									...
									<xsl:if test="count( n1:RangesCollection ) != 0">
										...
										<xsl:variable name="altova:nTableWidthIn_11">
											<xsl:choose>
												<xsl:when test="7.28346 &gt; $altova:nColumnWidthTw_10_2 - 0.02000 - 0.03125 - 0.03125">
													<xsl:value-of select="$altova:nColumnWidthTw_10_2 - 0.02000 - 0.03125 - 0.03125"/>
												</xsl:when>
												<xsl:otherwise>
										...
										<xsl:variable name="altova:nSumColumnWidthsTw_11" select="round(10489.69)"/>
										...
										<xsl:variable name="altova:nColumnWidthTw_11_0" select="round(1.18 * 1440 * $altova:TableWidthFactor_11)"/>
										<xsl:variable name="altova:nColumnWidthTw_11_1" select="round(1.18 * 1440 * $altova:TableWidthFactor_11)"/>
										<xsl:variable name="altova:nColumnWidthTw_11_2" select="round(4.92 * 1440 * $altova:TableWidthFactor_11)"/>
										<xsl:text>\pard\fs24</xsl:text>
										<xsl:if test="$templatetablelevel + 2 &gt; 0">\intbl</xsl:if>
										<xsl:text>\itap</xsl:text>
										<xsl:value-of select="$templatetablelevel + 2"/>
										...
										<xsl:variable name="altova:RowStyle31">
											...
											<xsl:text>\clvertalc\clcbpat141\clmgf\clbrdrt\brdrs\brdrcf1\brdrw28\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrl\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
											...
											<xsl:text>\clvertalc\clcbpat141\clmrg\clbrdrt\brdrs\brdrcf1\brdrw28\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
										...
										<xsl:variable name="altova:RowStyle32">
											...
											<xsl:variable name="altova:CurrGridPos_Tbl11_Col0_AfterColumn" select="$altova:CurrGridPos_Tbl11 + $altova:nColumnWidthTw_11_0"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_Tbl11_Col0_AfterColumn)"/>
											<xsl:text>\clvertalc\clcbpat141\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
											<xsl:if test="$altova:nColumnWidthTw_11_1 = $altova:nDefaultColumnWidthTw_11">
												<xsl:text>\clftsWidth1</xsl:text>
											</xsl:if>
											<xsl:text>\cellx</xsl:text>
									...
									<xsl:if test="count( n1:ValueListsCollection ) != 0">
										...
										<xsl:variable name="altova:nSumColumnWidthsTw_12" select="round(10489.19)"/>
										...
										<xsl:variable name="altova:nColumnWidthTw_12_0" select="round(1.18 * 1440 * $altova:TableWidthFactor_12)"/>
										<xsl:variable name="altova:nColumnWidthTw_12_1" select="round(6.10 * 1440 * $altova:TableWidthFactor_12)"/>
										<xsl:text>\pard\fs24</xsl:text>
										<xsl:if test="$templatetablelevel + 2 &gt; 0">\intbl</xsl:if>
										<xsl:text>\itap</xsl:text>
										<xsl:value-of select="$templatetablelevel + 2"/>
									...
									<xsl:if test="count( n1:CheckConstraintsCollection ) != 0">
										...
										<xsl:variable name="altova:nSumColumnWidthsTw_13" select="round(10489.19)"/>
										...
										<xsl:variable name="altova:nColumnWidthTw_13_0" select="round(6.10 * 1440 * $altova:TableWidthFactor_13)"/>
										<xsl:variable name="altova:nColumnWidthTw_13_1" select="round(1.18 * 1440 * $altova:TableWidthFactor_13)"/>
										<xsl:text>\pard\fs24</xsl:text>
										<xsl:if test="$templatetablelevel + 2 &gt; 0">\intbl</xsl:if>
										<xsl:text>\itap</xsl:text>
										<xsl:value-of select="$templatetablelevel + 2"/>
										...
										<xsl:variable name="altova:RowStyle37">
											...
											<xsl:text>\clvertalc\clcbpat141\clmrg\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
														...
														<xsl:for-each select="n1:CheckConstraintText">
															<xsl:for-each select="n1:CheckConstraintTextDetails">
																<xsl:for-each select="n1:CheckConstraintTextRow">
																	<xsl:apply-templates>
																		<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_13_0 div 1440) - 0.02000 - 0.02000 - 0.03125 - 0.03125"/>
																		<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 2"/>
																	</xsl:apply-templates>
																	<xsl:text>\par </xsl:text>
																</xsl:for-each>
												...
												<xsl:choose>
													<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
														<xsl:for-each select="n1:DatabaseType">
															<xsl:apply-templates>
																<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_13_1 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
																<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 2"/>
															</xsl:apply-templates>
														</xsl:for-each>
													</xsl:when>
						...
						<xsl:if test="count( n1:IdentifiersCollection )">
							...
							<xsl:variable name="altova:nSumColumnWidthsTw_14" select="round(14176.23)"/>
							...
							<xsl:variable name="altova:nColumnWidthTw_14_0" select="round(2.76 * 1440 * $altova:TableWidthFactor_14)"/>
							<xsl:variable name="altova:nColumnWidthTw_14_1" select="round(0.79 * 1440 * $altova:TableWidthFactor_14)"/>
							<xsl:variable name="altova:nColumnWidthTw_14_2" select="round(2.36 * 1440 * $altova:TableWidthFactor_14)"/>
							<xsl:variable name="altova:nColumnWidthTw_14_3" select="round(0.79 * 1440 * $altova:TableWidthFactor_14)"/>
							<xsl:variable name="altova:nColumnWidthTw_14_4" select="round(1.57 * 1440 * $altova:TableWidthFactor_14)"/>
							<xsl:variable name="altova:nColumnWidthTw_14_5" select="round(1.57 * 1440 * $altova:TableWidthFactor_14)"/>
							<xsl:text>\par </xsl:text>
							<xsl:text>\pard</xsl:text>
							<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
							<xsl:text>\itap</xsl:text>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:IdentifierName">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_14_0 div 1440) - 0.02000 - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:PrimaryIdentifier">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_14_1 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:ElementName">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_14_2 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:ElementType">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_14_3 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:SourceLabel">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_14_4 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:TargetLabel">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_14_5 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
						...
						<xsl:if test="count( n1:RelationshipsCollection )">
							...
							<xsl:variable name="altova:nTableWidthIn_15">
								<xsl:choose>
									<xsl:when test="9.84252 &gt; $altova:nMaxWidthIn">
										<xsl:value-of select="$altova:nMaxWidthIn"/>
									</xsl:when>
							...
							<xsl:variable name="altova:nSumColumnWidthsTw_15" select="round(14177.23)"/>
							...
							<xsl:variable name="altova:nColumnWidthTw_15_0" select="round(1.97 * 1440 * $altova:TableWidthFactor_15)"/>
							<xsl:variable name="altova:nColumnWidthTw_15_1" select="round(1.57 * 1440 * $altova:TableWidthFactor_15)"/>
							<xsl:variable name="altova:nColumnWidthTw_15_2" select="round(1.57 * 1440 * $altova:TableWidthFactor_15)"/>
							<xsl:variable name="altova:nColumnWidthTw_15_3" select="round(0.79 * 1440 * $altova:TableWidthFactor_15)"/>
							<xsl:variable name="altova:nColumnWidthTw_15_4" select="round(0.98 * 1440 * $altova:TableWidthFactor_15)"/>
							<xsl:variable name="altova:nColumnWidthTw_15_5" select="round(0.98 * 1440 * $altova:TableWidthFactor_15)"/>
							<xsl:variable name="altova:nColumnWidthTw_15_6" select="round(0.98 * 1440 * $altova:TableWidthFactor_15)"/>
							<xsl:variable name="altova:nColumnWidthTw_15_7" select="round(0.98 * 1440 * $altova:TableWidthFactor_15)"/>
							<xsl:text>\par </xsl:text>
							<xsl:text>\pard</xsl:text>
							<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
							<xsl:text>\itap</xsl:text>
							...
							<xsl:variable name="altova:RowStyle42">
								...
								<xsl:text>\clvertalc\clcbpat141\clbrdrt\brdrs\brdrcf1\brdrw28\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
								<xsl:if test="$altova:nColumnWidthTw_15_3 = $altova:nDefaultColumnWidthTw_15">
									<xsl:text>\clftsWidth1</xsl:text>
								</xsl:if>
								<xsl:text>\cellx</xsl:text>
								<xsl:variable name="altova:CurrGridPos_Tbl15_Col3_AfterColumn" select="$altova:CurrGridPos_Tbl15_Col2_AfterColumn + $altova:nColumnWidthTw_15_3"/>
								<xsl:value-of select="ceiling($altova:CurrGridPos_Tbl15_Col3_AfterColumn)"/>
								<xsl:text>\clvertalc\clcbpat141\clbrdrt\brdrs\brdrcf1\brdrw28\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
								<xsl:if test="$altova:nColumnWidthTw_15_4 = $altova:nDefaultColumnWidthTw_15">
									<xsl:text>\clftsWidth1</xsl:text>
								</xsl:if>
								<xsl:text>\cellx</xsl:text>
								<xsl:variable name="altova:CurrGridPos_Tbl15_Col4_AfterColumn" select="$altova:CurrGridPos_Tbl15_Col3_AfterColumn + $altova:nColumnWidthTw_15_4"/>
								<xsl:value-of select="ceiling($altova:CurrGridPos_Tbl15_Col4_AfterColumn)"/>
								<xsl:text>\clvertalc\clcbpat141\clbrdrt\brdrs\brdrcf1\brdrw28\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
								<xsl:if test="$altova:nColumnWidthTw_15_5 = $altova:nDefaultColumnWidthTw_15">
									<xsl:text>\clftsWidth1</xsl:text>
								</xsl:if>
								<xsl:text>\cellx</xsl:text>
								<xsl:variable name="altova:CurrGridPos_Tbl15_Col5_AfterColumn" select="$altova:CurrGridPos_Tbl15_Col4_AfterColumn + $altova:nColumnWidthTw_15_5"/>
								<xsl:value-of select="ceiling($altova:CurrGridPos_Tbl15_Col5_AfterColumn)"/>
								<xsl:text>\clvertalc\clcbpat141\clbrdrt\brdrs\brdrcf1\brdrw28\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
								<xsl:if test="$altova:nColumnWidthTw_15_6 = $altova:nDefaultColumnWidthTw_15">
									<xsl:text>\clftsWidth1</xsl:text>
								</xsl:if>
								<xsl:text>\cellx</xsl:text>
								<xsl:variable name="altova:CurrGridPos_Tbl15_Col6_AfterColumn" select="$altova:CurrGridPos_Tbl15_Col5_AfterColumn + $altova:nColumnWidthTw_15_6"/>
								<xsl:value-of select="ceiling($altova:CurrGridPos_Tbl15_Col6_AfterColumn)"/>
								<xsl:text>\clvertalc\clcbpat141\clbrdrt\brdrs\brdrcf1\brdrw28\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
								<xsl:if test="$altova:nColumnWidthTw_15_7 = $altova:nDefaultColumnWidthTw_15">
									<xsl:text>\clftsWidth1</xsl:text>
								</xsl:if>
								<xsl:text>\cellx</xsl:text>
								<xsl:variable name="altova:CurrGridPos_Tbl15_Col7_AfterColumn" select="$altova:CurrGridPos_Tbl15_Col6_AfterColumn + $altova:nColumnWidthTw_15_7"/>
								<xsl:value-of select="ceiling($altova:CurrGridPos_Tbl15_Col7_AfterColumn)"/>
							</xsl:variable>
							<xsl:if test="$templatetablelevel + 1 = 1">
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:SourceName">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_15_0 div 1440) - 0.02000 - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:SourceRole">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_15_1 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:TargetRole">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_15_2 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:InArc">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_15_3 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:Cardinality">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_15_4 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:DominantRole">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_15_5 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:Identifying">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_15_6 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:Transferable">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_15_7 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
						...
						<xsl:if test="count( n1:IncomingProcessesCollection )">
							...
							<xsl:variable name="altova:nTableWidthIn_16">
								<xsl:choose>
									<xsl:when test="9.84252 &gt; $altova:nMaxWidthIn">
										<xsl:value-of select="$altova:nMaxWidthIn"/>
									</xsl:when>
							...
							<xsl:variable name="altova:nSumColumnWidthsTw_16" select="round(14175.23)"/>
							<xsl:variable name="altova:TableWidthFactor_16">
								<xsl:choose>
									<xsl:when test="$altova:nSumColumnWidthsTw_16 &gt; $altova:nTableWidthTw_16">
										<xsl:value-of select="$altova:nTableWidthTw_16 div $altova:nSumColumnWidthsTw_16"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:value-of select="1"/>
									</xsl:otherwise>
							...
							<xsl:variable name="altova:nDefaultColumnWidthTw_16" select="0"/>
							<xsl:variable name="altova:nColumnWidthTw_16_0" select="round(2.95 * 1440 * $altova:TableWidthFactor_16)"/>
							<xsl:variable name="altova:nColumnWidthTw_16_1" select="round(2.95 * 1440 * $altova:TableWidthFactor_16)"/>
							<xsl:variable name="altova:nColumnWidthTw_16_2" select="round(0.98 * 1440 * $altova:TableWidthFactor_16)"/>
							<xsl:variable name="altova:nColumnWidthTw_16_3" select="round(2.95 * 1440 * $altova:TableWidthFactor_16)"/>
							<xsl:text>\par </xsl:text>
							<xsl:text>\pard</xsl:text>
							<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
							<xsl:text>\itap</xsl:text>
							...
							<xsl:variable name="altova:RowStyle44">
								...
								<xsl:text>\clvertalc\clcbpat141\clbrdrt\brdrs\brdrcf1\brdrw28\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
								<xsl:if test="$altova:nColumnWidthTw_16_3 = $altova:nDefaultColumnWidthTw_16">
									<xsl:text>\clftsWidth1</xsl:text>
								</xsl:if>
								<xsl:text>\cellx</xsl:text>
								<xsl:variable name="altova:CurrGridPos_Tbl16_Col3_AfterColumn" select="$altova:CurrGridPos_Tbl16_Col2_AfterColumn + $altova:nColumnWidthTw_16_3"/>
								<xsl:value-of select="ceiling($altova:CurrGridPos_Tbl16_Col3_AfterColumn)"/>
							</xsl:variable>
							<xsl:if test="$templatetablelevel + 1 = 1">
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:IncomingProcessName">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_16_0 div 1440) - 0.02000 - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:IncomingFlowName">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_16_1 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:IncomingCRUDCode">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_16_2 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:IncomingDFDName">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_16_3 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
						...
						<xsl:if test="count( n1:OutgoingProcessesCollection ) !=0">
							...
							<xsl:variable name="altova:nTableWidthIn_17">
								<xsl:choose>
									<xsl:when test="9.84252 &gt; $altova:nMaxWidthIn">
										<xsl:value-of select="$altova:nMaxWidthIn"/>
									</xsl:when>
							...
							<xsl:variable name="altova:nSumColumnWidthsTw_17" select="round(14175.23)"/>
							<xsl:variable name="altova:TableWidthFactor_17">
								<xsl:choose>
									<xsl:when test="$altova:nSumColumnWidthsTw_17 &gt; $altova:nTableWidthTw_17">
										<xsl:value-of select="$altova:nTableWidthTw_17 div $altova:nSumColumnWidthsTw_17"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:value-of select="1"/>
									</xsl:otherwise>
							...
							<xsl:variable name="altova:nDefaultColumnWidthTw_17" select="0"/>
							<xsl:variable name="altova:nColumnWidthTw_17_0" select="round(2.95 * 1440 * $altova:TableWidthFactor_17)"/>
							<xsl:variable name="altova:nColumnWidthTw_17_1" select="round(2.95 * 1440 * $altova:TableWidthFactor_17)"/>
							<xsl:variable name="altova:nColumnWidthTw_17_2" select="round(0.98 * 1440 * $altova:TableWidthFactor_17)"/>
							<xsl:variable name="altova:nColumnWidthTw_17_3" select="round(2.95 * 1440 * $altova:TableWidthFactor_17)"/>
							<xsl:text>\par </xsl:text>
							<xsl:text>\pard</xsl:text>
							<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
							<xsl:text>\itap</xsl:text>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:OutgoingProcessName">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_17_0 div 1440) - 0.02000 - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:OutgoingFlowName">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_17_1 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:OutgoingCRUDCode">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_17_2 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
									...
									<xsl:choose>
										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
											<xsl:for-each select="n1:OutgoingDFDName">
												<xsl:apply-templates>
													<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_17_3 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
													<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
												</xsl:apply-templates>
											</xsl:for-each>
										</xsl:when>
	...
	<xsl:template name="altova:Section_0_FooterRight">
		...
		<xsl:variable name="altova:nTableWidthIn_18">
			<xsl:choose>
				<xsl:when test="9.84252 &gt; $altova:nMaxWidthIn">
					<xsl:value-of select="$altova:nMaxWidthIn"/>
				</xsl:when>
		...
		<xsl:variable name="altova:nSumColumnWidthsTw_18" select="round(14174.23)"/>
		...
		<xsl:variable name="altova:nColumnWidthTw_18_0" select="round(7.09 * 1440 * $altova:TableWidthFactor_18)"/>
		<xsl:variable name="altova:nColumnWidthTw_18_1" select="round(2.76 * 1440 * $altova:TableWidthFactor_18)"/>
		<xsl:text>\pard</xsl:text>
		<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
		<xsl:text>\itap</xsl:text>
		<xsl:value-of select="$templatetablelevel + 1"/>
	...
	<xsl:template name="altova:Section_0_FooterLeft">
		...
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_19" select="."/>
		<xsl:variable name="altova:nTableWidthIn_19">
			<xsl:choose>
				<xsl:when test="9.84252 &gt; $altova:nMaxWidthIn">
					<xsl:value-of select="$altova:nMaxWidthIn"/>
				</xsl:when>
		...
		<xsl:variable name="altova:nSumColumnWidthsTw_19" select="round(14174.23)"/>
		<xsl:variable name="altova:TableWidthFactor_19">
			<xsl:choose>
				<xsl:when test="$altova:nSumColumnWidthsTw_19 &gt; $altova:nTableWidthTw_19">
					<xsl:value-of select="$altova:nTableWidthTw_19 div $altova:nSumColumnWidthsTw_19"/>
				</xsl:when>
				<xsl:otherwise>
					<xsl:value-of select="1"/>
				</xsl:otherwise>
		...
		<xsl:variable name="altova:nDefaultColumnWidthTw_19" select="0"/>
		<xsl:variable name="altova:nColumnWidthTw_19_0" select="round(7.09 * 1440 * $altova:TableWidthFactor_19)"/>
		<xsl:variable name="altova:nColumnWidthTw_19_1" select="round(2.76 * 1440 * $altova:TableWidthFactor_19)"/>
		<xsl:text>\pard</xsl:text>
		<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
		<xsl:text>\itap</xsl:text>
		<xsl:value-of select="$templatetablelevel + 1"/>
