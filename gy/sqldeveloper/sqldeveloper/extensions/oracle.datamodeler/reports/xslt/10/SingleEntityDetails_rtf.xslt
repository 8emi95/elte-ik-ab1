...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_e" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="altova altovaext clitype fn iso4217 ix java link n1 sps xbrldi xbrli xlink xs xsd xsi">
	...
	<xsl:template name="altova:DocumentSection_0">
		...
		<xsl:for-each select="$XML">
			<xsl:for-each select="n1:root">
				...
				<xsl:variable name="altova:nSumColumnWidthsTw_1" select="round(13607.80)"/>
				...
				<xsl:variable name="altova:nColumnWidthTw_1_0" select="round(5.91 * 1440 * $altova:TableWidthFactor_1)"/>
				<xsl:variable name="altova:nColumnWidthTw_1_1" select="round(0.39 * 1440 * $altova:TableWidthFactor_1)"/>
				<xsl:variable name="altova:nColumnWidthTw_1_2" select="round(3.15 * 1440 * $altova:TableWidthFactor_1)"/>
				<xsl:text>\par </xsl:text>
				<xsl:text>\pard</xsl:text>
				<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
				<xsl:text>\itap</xsl:text>
				...
				<xsl:variable name="altova:nTableWidthIn_2">
					<xsl:choose>
						<xsl:when test="5.90551 &gt; $altova:nColumnWidthTw_1_0">
							<xsl:value-of select="$altova:nColumnWidthTw_1_0"/>
						</xsl:when>
						<xsl:otherwise>
				...
				<xsl:variable name="altova:nSumColumnWidthsTw_2" select="round(8504.94)"/>
				...
				<xsl:variable name="altova:nColumnWidthTw_2_1" select="round(4.33 * 1440 * $altova:TableWidthFactor_2)"/>
				<xsl:text>\pard</xsl:text>
				...
				<xsl:if test="count( n1:MappedTablesCollection )">
					...
					<xsl:variable name="altova:nTableWidthIn_3">
						<xsl:choose>
							<xsl:when test="3.14961 &gt; $altova:nColumnWidthTw_1_2">
								<xsl:value-of select="$altova:nColumnWidthTw_1_2"/>
							</xsl:when>
							<xsl:otherwise>
					...
					<xsl:variable name="altova:nSumColumnWidthsTw_3" select="round(4535.93)"/>
					...
					<xsl:variable name="altova:nColumnWidthTw_3_0" select="round(3.15 * 1440 * $altova:TableWidthFactor_3)"/>
				...
				<xsl:if test="count( n1:DescriptionNotes )">
					...
					<xsl:for-each select="n1:DescriptionNotes">
						...
						<xsl:variable name="altova:nSumColumnWidthsTw_4" select="round(11339.58)"/>
						...
						<xsl:variable name="altova:nColumnWidthTw_4_0" select="round(1.57 * 1440 * $altova:TableWidthFactor_4)"/>
						<xsl:variable name="altova:nColumnWidthTw_4_1" select="round(6.30 * 1440 * $altova:TableWidthFactor_4)"/>
						<xsl:text>\pard</xsl:text>
						<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
						<xsl:text>\itap</xsl:text>
						<xsl:value-of select="$templatetablelevel + 1"/>
				...
				<xsl:if test="count( n1:QuantitativeInfoCollection )">
					...
					<xsl:for-each select="n1:QuantitativeInfoCollection">
						...
						<xsl:variable name="altova:nSumColumnWidthsTw_5" select="round(4536.43)"/>
						...
						<xsl:variable name="altova:nColumnWidthTw_5_1" select="round(1.57 * 1440 * $altova:TableWidthFactor_5)"/>
						<xsl:text>\pard</xsl:text>
						<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
						<xsl:text>\itap</xsl:text>
						<xsl:value-of select="$templatetablelevel + 1"/>
				...
				<xsl:if test="count( n1:DiagramsCollection)">
					...
					<xsl:variable name="altova:nSumColumnWidthsTw_6" select="round(4535.93)"/>
					...
					<xsl:variable name="altova:nColumnWidthTw_6_0" select="round(3.15 * 1440 * $altova:TableWidthFactor_6)"/>
					<xsl:text>\pard</xsl:text>
					<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
					<xsl:text>\itap</xsl:text>
					<xsl:value-of select="$templatetablelevel + 1"/>
				...
				<xsl:if test="count( n1:AttributesCollection )">
					...
					<xsl:variable name="altova:nSumColumnWidthsTw_7" select="round(14178.73)"/>
					...
					<xsl:variable name="altova:nColumnWidthTw_7_0" select="round(0.39 * 1440 * $altova:TableWidthFactor_7)"/>
					<xsl:variable name="altova:nColumnWidthTw_7_1" select="round(1.97 * 1440 * $altova:TableWidthFactor_7)"/>
					<xsl:variable name="altova:nColumnWidthTw_7_2" select="round(0.31 * 1440 * $altova:TableWidthFactor_7)"/>
					<xsl:variable name="altova:nColumnWidthTw_7_3" select="round(0.31 * 1440 * $altova:TableWidthFactor_7)"/>
					<xsl:variable name="altova:nColumnWidthTw_7_4" select="round(0.31 * 1440 * $altova:TableWidthFactor_7)"/>
					<xsl:variable name="altova:nColumnWidthTw_7_5" select="round(1.57 * 1440 * $altova:TableWidthFactor_7)"/>
					<xsl:variable name="altova:nColumnWidthTw_7_6" select="round(0.39 * 1440 * $altova:TableWidthFactor_7)"/>
					<xsl:variable name="altova:nColumnWidthTw_7_7" select="round(1.14 * 1440 * $altova:TableWidthFactor_7)"/>
					<xsl:variable name="altova:nColumnWidthTw_7_8" select="round(1.14 * 1440 * $altova:TableWidthFactor_7)"/>
					<xsl:variable name="altova:nColumnWidthTw_7_9" select="round(1.14 * 1440 * $altova:TableWidthFactor_7)"/>
					<xsl:variable name="altova:nColumnWidthTw_7_10" select="round(1.14 * 1440 * $altova:TableWidthFactor_7)"/>
					<xsl:text>\par </xsl:text>
					<xsl:text>\pard</xsl:text>
					<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
					<xsl:text>\itap</xsl:text>
					...
					<xsl:variable name="altova:RowStyle23">
						...
						<xsl:text>\clvertalc\clcbpat141\clbrdrt\brdrs\brdrcf1\brdrw28\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
						<xsl:if test="$altova:nColumnWidthTw_7_9 = $altova:nDefaultColumnWidthTw_7">
							<xsl:text>\clftsWidth1</xsl:text>
						</xsl:if>
						<xsl:text>\cellx</xsl:text>
						<xsl:variable name="altova:CurrGridPos_Tbl7_Col9_AfterColumn" select="$altova:CurrGridPos_Tbl7_Col8_AfterColumn + $altova:nColumnWidthTw_7_9"/>
						<xsl:value-of select="ceiling($altova:CurrGridPos_Tbl7_Col9_AfterColumn)"/>
						<xsl:text>\clvertalc\clcbpat141\clbrdrt\brdrs\brdrcf1\brdrw28\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
						<xsl:if test="$altova:nColumnWidthTw_7_10 = $altova:nDefaultColumnWidthTw_7">
							<xsl:text>\clftsWidth1</xsl:text>
						</xsl:if>
						<xsl:text>\cellx</xsl:text>
						<xsl:variable name="altova:CurrGridPos_Tbl7_Col10_AfterColumn" select="$altova:CurrGridPos_Tbl7_Col9_AfterColumn + $altova:nColumnWidthTw_7_10"/>
						<xsl:value-of select="ceiling($altova:CurrGridPos_Tbl7_Col10_AfterColumn)"/>
					</xsl:variable>
					<xsl:if test="$templatetablelevel + 1 = 1">
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:FK">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_7_3 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:M">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_7_4 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:DataType">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_7_5 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:DataTypeKind">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_7_6 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:DomainName">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_7_7 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:Formula">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_7_8 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:PreferredAbbreviation">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_7_9 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:AttributeSynonyms">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_7_10 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
				...
				<xsl:if test="count( n1:AttributesCommentsCollection )">
					...
					<xsl:variable name="altova:nSumColumnWidthsTw_8" select="round(14175.23)"/>
					...
					<xsl:variable name="altova:nColumnWidthTw_8_1" select="round(2.36 * 1440 * $altova:TableWidthFactor_8)"/>
					<xsl:variable name="altova:nColumnWidthTw_8_2" select="round(3.54 * 1440 * $altova:TableWidthFactor_8)"/>
					<xsl:variable name="altova:nColumnWidthTw_8_3" select="round(3.54 * 1440 * $altova:TableWidthFactor_8)"/>
					<xsl:text>\par </xsl:text>
					<xsl:text>\pard</xsl:text>
					<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
					<xsl:text>\itap</xsl:text>
				...
				<xsl:if test="count( n1:ConstraintsCollection )">
					...
					<xsl:variable name="altova:nSumColumnWidthsTw_9" select="round(14174.73)"/>
					...
					<xsl:variable name="altova:nColumnWidthTw_9_1" select="round(1.18 * 1440 * $altova:TableWidthFactor_9)"/>
					<xsl:variable name="altova:nColumnWidthTw_9_2" select="round(7.48 * 1440 * $altova:TableWidthFactor_9)"/>
					<xsl:text>\par </xsl:text>
					<xsl:text>\pard</xsl:text>
					<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
					<xsl:text>\itap</xsl:text>
						...
						<xsl:for-each select="n1:ConstraintDetails">
							...
							<xsl:if test="count( n1:RangesCollection ) != 0">
								...
								<xsl:variable name="altova:nTableWidthIn_10">
									<xsl:choose>
										<xsl:when test="7.28346 &gt; $altova:nColumnWidthTw_9_2 - 0.02000 - 0.03125 - 0.03125">
											<xsl:value-of select="$altova:nColumnWidthTw_9_2 - 0.02000 - 0.03125 - 0.03125"/>
										</xsl:when>
										<xsl:otherwise>
								...
								<xsl:variable name="altova:nSumColumnWidthsTw_10" select="round(10489.69)"/>
								...
								<xsl:variable name="altova:nColumnWidthTw_10_2" select="round(4.92 * 1440 * $altova:TableWidthFactor_10)"/>
								<xsl:text>\pard\fs24</xsl:text>
								<xsl:if test="$templatetablelevel + 2 &gt; 0">\intbl</xsl:if>
								<xsl:text>\itap</xsl:text>
								<xsl:value-of select="$templatetablelevel + 2"/>
										...
										<xsl:choose>
											<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
												<xsl:for-each select="n1:RangeShortDescription">
													<xsl:apply-templates>
														<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_10_2 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
														<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 2"/>
													</xsl:apply-templates>
												</xsl:for-each>
											</xsl:when>
							...
							<xsl:if test="count( n1:ValueListsCollection ) != 0">
								...
								<xsl:variable name="altova:nSumColumnWidthsTw_11" select="round(10489.19)"/>
								...
								<xsl:variable name="altova:nColumnWidthTw_11_1" select="round(6.10 * 1440 * $altova:TableWidthFactor_11)"/>
								<xsl:text>\pard\fs24</xsl:text>
								<xsl:if test="$templatetablelevel + 2 &gt; 0">\intbl</xsl:if>
								<xsl:text>\itap</xsl:text>
								<xsl:value-of select="$templatetablelevel + 2"/>
							...
							<xsl:if test="count( n1:CheckConstraintsCollection ) != 0">
								...
								<xsl:variable name="altova:nColumnWidthTw_12_0" select="round(6.10 * 1440 * $altova:TableWidthFactor_12)"/>
								<xsl:variable name="altova:nColumnWidthTw_12_1" select="round(1.18 * 1440 * $altova:TableWidthFactor_12)"/>
								<xsl:text>\pard\fs24</xsl:text>
								<xsl:if test="$templatetablelevel + 2 &gt; 0">\intbl</xsl:if>
								<xsl:text>\itap</xsl:text>
								<xsl:value-of select="$templatetablelevel + 2"/>
				...
				<xsl:if test="count( n1:IdentifiersCollection )">
					...
					<xsl:variable name="altova:nSumColumnWidthsTw_13" select="round(14176.23)"/>
					...
					<xsl:variable name="altova:nColumnWidthTw_13_0" select="round(2.76 * 1440 * $altova:TableWidthFactor_13)"/>
					<xsl:variable name="altova:nColumnWidthTw_13_1" select="round(0.79 * 1440 * $altova:TableWidthFactor_13)"/>
					<xsl:variable name="altova:nColumnWidthTw_13_2" select="round(2.36 * 1440 * $altova:TableWidthFactor_13)"/>
					<xsl:variable name="altova:nColumnWidthTw_13_3" select="round(0.79 * 1440 * $altova:TableWidthFactor_13)"/>
					<xsl:variable name="altova:nColumnWidthTw_13_4" select="round(1.57 * 1440 * $altova:TableWidthFactor_13)"/>
					<xsl:variable name="altova:nColumnWidthTw_13_5" select="round(1.57 * 1440 * $altova:TableWidthFactor_13)"/>
					<xsl:text>\par </xsl:text>
					<xsl:text>\pard</xsl:text>
					<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
					<xsl:text>\itap</xsl:text>
					...
					<xsl:variable name="altova:RowStyle38">
						...
						<xsl:text>\clvertalc\clcbpat141\clbrdrt\brdrs\brdrcf1\brdrw28\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
						<xsl:if test="$altova:nColumnWidthTw_13_5 = $altova:nDefaultColumnWidthTw_13">
							<xsl:text>\clftsWidth1</xsl:text>
						</xsl:if>
						<xsl:text>\cellx</xsl:text>
						<xsl:variable name="altova:CurrGridPos_Tbl13_Col5_AfterColumn" select="$altova:CurrGridPos_Tbl13_Col4_AfterColumn + $altova:nColumnWidthTw_13_5"/>
						<xsl:value-of select="ceiling($altova:CurrGridPos_Tbl13_Col5_AfterColumn)"/>
					</xsl:variable>
					<xsl:if test="$templatetablelevel + 1 = 1">
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:ElementName">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_13_2 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:ElementType">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_13_3 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:SourceLabel">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_13_4 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:TargetLabel">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_13_5 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
				...
				<xsl:if test="count( n1:RelationshipsCollection )">
					...
					<xsl:variable name="altova:nSumColumnWidthsTw_14" select="round(14177.23)"/>
					...
					<xsl:variable name="altova:nColumnWidthTw_14_0" select="round(1.97 * 1440 * $altova:TableWidthFactor_14)"/>
					<xsl:variable name="altova:nColumnWidthTw_14_1" select="round(1.57 * 1440 * $altova:TableWidthFactor_14)"/>
					<xsl:variable name="altova:nColumnWidthTw_14_2" select="round(1.57 * 1440 * $altova:TableWidthFactor_14)"/>
					<xsl:variable name="altova:nColumnWidthTw_14_3" select="round(0.79 * 1440 * $altova:TableWidthFactor_14)"/>
					<xsl:variable name="altova:nColumnWidthTw_14_4" select="round(0.98 * 1440 * $altova:TableWidthFactor_14)"/>
					<xsl:variable name="altova:nColumnWidthTw_14_5" select="round(0.98 * 1440 * $altova:TableWidthFactor_14)"/>
					<xsl:variable name="altova:nColumnWidthTw_14_6" select="round(0.98 * 1440 * $altova:TableWidthFactor_14)"/>
					<xsl:variable name="altova:nColumnWidthTw_14_7" select="round(0.98 * 1440 * $altova:TableWidthFactor_14)"/>
					<xsl:text>\par </xsl:text>
					<xsl:text>\pard</xsl:text>
					<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
					<xsl:text>\itap</xsl:text>
					...
					<xsl:variable name="altova:RowStyle40">
						...
						<xsl:text>\clvertalc\clcbpat141\clbrdrt\brdrs\brdrcf1\brdrw28\clbrdrb\brdrs\brdrcf1\brdrw28\clbrdrr\brdrs\brdrcf1\brdrw28\clpadl45\clpadfl3\clpadb45\clpadfb3\clpadt45\clpadft3\clpadr45\clpadfr3</xsl:text>
						<xsl:if test="$altova:nColumnWidthTw_14_7 = $altova:nDefaultColumnWidthTw_14">
							<xsl:text>\clftsWidth1</xsl:text>
						</xsl:if>
						<xsl:text>\cellx</xsl:text>
						<xsl:variable name="altova:CurrGridPos_Tbl14_Col7_AfterColumn" select="$altova:CurrGridPos_Tbl14_Col6_AfterColumn + $altova:nColumnWidthTw_14_7"/>
						<xsl:value-of select="ceiling($altova:CurrGridPos_Tbl14_Col7_AfterColumn)"/>
					</xsl:variable>
					<xsl:if test="$templatetablelevel + 1 = 1">
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:Identifying">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_14_6 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
							...
							<xsl:choose>
								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
									<xsl:for-each select="n1:Transferable">
										<xsl:apply-templates>
											<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_14_7 div 1440) - 0.02000 - 0.03125 - 0.03125"/>
											<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
										</xsl:apply-templates>
									</xsl:for-each>
								</xsl:when>
				...
				<xsl:if test="count( n1:IncomingProcessesCollection )">
					...
					<xsl:variable name="altova:nSumColumnWidthsTw_15" select="round(14175.23)"/>
					...
					<xsl:variable name="altova:nColumnWidthTw_15_0" select="round(2.95 * 1440 * $altova:TableWidthFactor_15)"/>
					<xsl:variable name="altova:nColumnWidthTw_15_1" select="round(2.95 * 1440 * $altova:TableWidthFactor_15)"/>
					<xsl:variable name="altova:nColumnWidthTw_15_2" select="round(0.98 * 1440 * $altova:TableWidthFactor_15)"/>
					<xsl:variable name="altova:nColumnWidthTw_15_3" select="round(2.95 * 1440 * $altova:TableWidthFactor_15)"/>
					<xsl:text>\par </xsl:text>
					<xsl:text>\pard</xsl:text>
					<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
					<xsl:text>\itap</xsl:text>
	...
	<xsl:template name="altova:Section_0_FooterRight">
		...
		<xsl:variable name="altova:nSumColumnWidthsTw_17" select="round(14174.23)"/>
		...
		<xsl:variable name="altova:nColumnWidthTw_17_0" select="round(7.09 * 1440 * $altova:TableWidthFactor_17)"/>
		<xsl:variable name="altova:nColumnWidthTw_17_1" select="round(2.76 * 1440 * $altova:TableWidthFactor_17)"/>
		<xsl:text>\pard</xsl:text>
		<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
		<xsl:text>\itap</xsl:text>
		<xsl:value-of select="$templatetablelevel + 1"/>
