...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_srs" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:variable name="altova:DocumentMonolith">
		<altova:Document altova:Url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.rtf') else ''}">
			...
			<altova:DocumentSection altova:PageWidthPt="841" altova:MarginLeftPt="43" altova:MarginRightPt="43" altova:PageHeightPt="595" altova:MarginTopPt="56" altova:MarginBottomPt="56" altova:Columns="1" altova:ColumnGapPt="36"/>
			...
			<altova:new-line/>
			<altova:paragraph altova:whitespace="preserve-all" altova:selector="center*" altova:character-styles="\f0\fs24" altova:paragraph-styles="\sl0\qc" altova:is-div="true">
				<xsl:for-each select="$XML">
					<xsl:for-each select="n1:root">
						<xsl:for-each select="n1:Title">
							<altova:text-block altova:whitespace="preserve-all" altova:selector="*" altova:character-styles="\fs26\b" altova:character-reset-styles="\fs24\b0">
								<xsl:apply-templates/>
							</altova:text-block>
						</xsl:for-each>
					</xsl:for-each>
			...
			<xsl:for-each select="$XML">
				...
				<xsl:if test="n1:root/n1:ShowFilter = &apos;true&apos;">
					...
					<altova:table>
						...
						<altova:TableStyles altova:nBorderSpacingPt="0.00" altova:sBorderCollapse="collapse" altova:nCellPaddingPt="2.25" altova:nLeftMarginPt="0.00">
						...
						<altova:table-row>
							...
							<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\sl0">
								...
								<altova:text-block altova:whitespace="preserve-all" altova:selector="*">
									<xsl:text>\u80?\u97?\u116?\u116?\u101?\u114?\u110?</xsl:text>
								</altova:text-block>
							</altova:table-cell>
						...
						<altova:table-row>
							...
							<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\sl0">
								...
								<altova:text-block altova:whitespace="preserve-all" altova:selector="*">
									<xsl:text>\u70?\u105?\u108?\u116?\u101?\u114?</xsl:text>
								</altova:text-block>
							</altova:table-cell>
							<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\ql\sl0">
								<altova:TableCellStyles altova:nColSpan="1">
				...
				<xsl:text>{</xsl:text>
				<xsl:text>\footerl </xsl:text>
				<xsl:call-template name="altova:Section_2_FooterLeft"/>
				<xsl:text>}</xsl:text>
				<xsl:text>{</xsl:text>
				<xsl:text>\footerr </xsl:text>
				<xsl:call-template name="altova:Section_2_FooterRight"/>
				<xsl:text>}</xsl:text>
				<altova:AfterHeadersFooters/>
				<xsl:for-each select="n1:root">
					<altova:new-line/>
					...
					<altova:table>
						...
						<altova:TableGrid>
							<xsl:if test="n1:ObjectsCollection/n1:Column1/n1:show = &apos;Y&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
						...
						<altova:TableStyles altova:nBorderSpacingPt="0.00" altova:sBorderCollapse="collapse" altova:nCellPaddingPt="2.25" altova:nLeftMarginPt="0.00">
							<xsl:text>\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
							<altova:TableWidth altova:sWidth="{n1:TW}"/>
						</altova:TableStyles>
						<xsl:for-each select="n1:ObjectsCollection">
							<altova:table-row>
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column1/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
										...
										<xsl:for-each select="n1:Column1">
											<xsl:for-each select="n1:customName">
												<altova:text-block altova:whitespace="preserve-all" altova:selector="*" altova:character-styles="\b" altova:character-reset-styles="\b0">
													<xsl:apply-templates/>
												</altova:text-block>
											</xsl:for-each>
										</xsl:for-each>
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column2/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column3/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column4/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column5/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column6/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column7/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column8/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column9/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column10/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column11/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column12/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column13/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column14/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column15/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column16/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column17/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column18/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column19/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column20/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column21/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column22/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column23/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column24/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column25/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column26/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column27/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column28/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column29/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column30/n1:show = &apos;Y&apos;)">
									<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\qc\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
							...
							<xsl:for-each select="n1:ObjectDetails">
								...
								<altova:table-row>
									...
									<xsl:if test="$altova:CurrContextGrid_3/(n1:ObjectsCollection/n1:Column1/n1:show = &apos;Y&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Bottom>
...
$v_Property1_Value
	...
	<xsl:template name="altova:Section_2_FooterRight">
		<xsl:variable name="templatetablelevel" select="0"/>
		...
		<altova:table>
			...
			<altova:table-row>
				...
				<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
					<altova:TableCellStyles altova:nColSpan="1">
						<xsl:text>\clvertalc</xsl:text>
					</altova:TableCellStyles>
					<altova:text-block altova:whitespace="preserve-all" altova:selector="*">
				...
				<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qr\sl0">
					<altova:TableCellStyles altova:nColSpan="1">
						<xsl:text>\clvertalc</xsl:text>
					</altova:TableCellStyles>
					<altova:text-block altova:whitespace="preserve-all" altova:selector="*">
	...
	<xsl:template name="altova:Section_2_FooterLeft">
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_4" select="."/>
		<altova:table>
			<xsl:variable name="altova:ColumnData"/>
	...
	<xsl:variable name="altova:paragraph-style-selectors-in-use" select="('p','div','address','center','blockquote','fieldset','pre','pre-wrap','h1','h2','h3','h4','h5','h6','center*')"/>
	...
	<xsl:template match="/">
		<xsl:for-each select="$altova:nodesAllSeparateDocuments">
			...
			<xsl:result-document href="{$altova:nodeDocument/@altova:Url}">
				...
				<xsl:text>{\s15\qc\sl0\f0\fs24\snext0 Center ;}</xsl:text>
				<xsl:text>{\*\cs16\fs26\b\snext0 Character ;}</xsl:text>
				<xsl:text>}</xsl:text>
