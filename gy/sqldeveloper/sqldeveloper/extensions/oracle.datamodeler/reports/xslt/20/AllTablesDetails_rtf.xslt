...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_at" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:variable name="altova:DocumentMonolith">
		<altova:Document altova:Url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.rtf') else ''}">
			...
			<altova:DocumentSection altova:PageWidthPt="841" altova:MarginLeftPt="56" altova:MarginRightPt="56" altova:PageHeightPt="595" altova:MarginTopPt="56" altova:MarginBottomPt="56" altova:Columns="1" altova:ColumnGapPt="0"/>
			...
			<xsl:for-each select="$XML">
				<xsl:for-each select="n1:root">
					<altova:new-line/>
					<altova:paragraph altova:selector="center" altova:character-styles="\f0\fs24" altova:paragraph-styles="\qc" altova:is-div="true">
						<xsl:for-each select="n1:ReportCaption">
							<altova:text-block altova:character-styles="\fs26\b" altova:character-reset-styles="\fs24\b0">
								<xsl:apply-templates/>
							</altova:text-block>
						</xsl:for-each>
					</altova:paragraph>
					...
					<altova:table>
						...
						<altova:TableStyles altova:nBorderSpacingPt="0.00" altova:sBorderCollapse="separate" altova:nCellPaddingPt="2.25" altova:nLeftMarginPt="0.00">
						...
						<altova:table-row>
							...
							<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\sl0">
								<altova:TableCellStyles altova:nColSpan="1">
									<xsl:text>\clvertalc</xsl:text>
									<xsl:element name="altova:TableCellColor">
										<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
									</xsl:element>
									<altova:Borders>
										<altova:Top>
											...
											<xsl:element name="altova:BorderWidthPt">
												<xsl:attribute name="altova:nWidthPt" select="altova:MapCssToBorderWidthPt('thin')"/>
											</xsl:element>
										</altova:Top>
										<altova:Bottom>
							...
							<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
								<altova:TableCellStyles altova:nColSpan="1">
									<xsl:text>\clvertalc</xsl:text>
									<altova:Borders>
										<altova:Top>
					...
					<xsl:if test="count(n1:SubViewsCollection)">
						<altova:new-line/>
						<altova:text-block>
							<xsl:text>\u83?\u117?\u98?\u86?\u105?\u101?\u119?\u115?</xsl:text>
						</altova:text-block>
						<altova:new-line/>
						...
						<altova:table>
							...
							<altova:TableGrid>
								<altova:GridCol altova:sWidth="2268" altova:sType="twips"/>
								<altova:GridCol altova:sWidth="4252" altova:sType="twips"/>
								<altova:GridCol altova:sWidth="4252" altova:sType="twips"/>
							...
							<altova:table-row>
								...
								<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\qc\sl0">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
									...
									<altova:text-block>
										<xsl:text>\u83?\u117?\u98?\u86?\u105?\u101?\u119?</xsl:text>
									</altova:text-block>
								</altova:table-cell>
								...
								<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\qc\sl0">
									...
									<altova:text-block>
										<xsl:text>\u79?\u98?\u106?\u101?\u99?\u116?</xsl:text>
									</altova:text-block>
								</altova:table-cell>
							</altova:table-row>
							<xsl:for-each select="n1:SubViewsCollection">
								<xsl:for-each select="n1:SubViewsDetails">
									<altova:table-row>
										...
										<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\ql\sl0">
											<altova:TableCellStyles altova:nColSpan="1">
										...
										<altova:table-cell altova:paragraph-styles="\sl0">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalt</xsl:text>
												<altova:Borders>
													<altova:Bottom>
										...
										<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\ql\sl0">
											...
											<xsl:for-each select="n1:SWObjects">
												<xsl:for-each select="n1:SWObject">
													<altova:link altova:Dest="{concat(&apos;#&apos;,.)}">
														<altova:text-block>
															<xsl:apply-templates/>
														</altova:text-block>
														<altova:new-line/>
					...
					<xsl:for-each select="n1:TablesCollection">
						<xsl:for-each select="n1:TableDetails">
							<altova:DocumentSection altova:PageWidthPt="841" altova:MarginLeftPt="56" altova:MarginRightPt="56" altova:PageHeightPt="595" altova:MarginTopPt="56" altova:MarginBottomPt="56" altova:Columns="1" altova:ColumnGapPt="0"/>
							<xsl:text>\sect\sectd\sbkpage\facingp\pgwsxn16820\pghsxn11900\lndscpsxn\margtsxn-1120\marglsxn1120\margbsxn-1120\margrsxn1120\headery380\footery380\cols1\colsx0\pgndec</xsl:text>
							<xsl:text>{</xsl:text>
							<xsl:text>\headerl </xsl:text>
							<xsl:call-template name="EmptyHeader"/>
							<xsl:text>}</xsl:text>
							...
							<xsl:text>{</xsl:text>
							<xsl:text>\footerl </xsl:text>
							<xsl:call-template name="altova:Section_3_FooterLeft"/>
							<xsl:text>}</xsl:text>
							<xsl:text>{</xsl:text>
							<xsl:text>\footerr </xsl:text>
							<xsl:call-template name="altova:Section_3_FooterRight"/>
							<xsl:text>}</xsl:text>
							<altova:AfterHeadersFooters/>
							...
							<altova:table>
								...
								<altova:TableGrid>
									<altova:GridCol altova:sWidth="2268" altova:sType="twips"/>
									<altova:GridCol altova:sWidth="6236" altova:sType="twips"/>
								</altova:TableGrid>
								<altova:TableStyles altova:nBorderSpacingPt="0.00" altova:sBorderCollapse="separate" altova:nCellPaddingPt="2.25" altova:nLeftMarginPt="0.00">
									<xsl:text>\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
									<altova:TableWidth altova:sWidth="{'15cm'}"/>
								</altova:TableStyles>
								<altova:table-row>
									<xsl:element name="altova:TableRowStyles">
										<xsl:text>\trrh0</xsl:text>
									...
									<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\sl0">
										...
										<altova:text-block>
											<xsl:text>\u84?\u97?\u98?\u108?\u101?\u32?\u78?\u97?\u109?\u101?</xsl:text>
										</altova:text-block>
									</altova:table-cell>
									<altova:table-cell altova:paragraph-styles="\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#a5e7ff'"/>
											</xsl:element>
											<altova:Borders>
												<altova:Top>
													<xsl:text>\clbrdrt</xsl:text>
										...
										<altova:paragraph altova:selector="h1" altova:character-styles="\f1\fs48\b" altova:character-reset-styles="\fs24\f0\b0" altova:is-div="false">
											<altova:bookmark name="{n1:TableName}">
												<xsl:choose>
													<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
														<xsl:for-each select="n1:TableName">
															<altova:text-block altova:character-styles="\fs16" altova:character-reset-styles="\fs24">
																<xsl:apply-templates/>
															</altova:text-block>
														</xsl:for-each>
													</xsl:when>
								...
								<altova:table-row>
									...
									<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\sl0">
										...
										<altova:text-block>
											<xsl:text>\u70?\u117?\u110?\u99?\u116?\u105?\u111?\u110?\u97?\u108?\u32?\u78?\u97?\u109?\u101?</xsl:text>
										</altova:text-block>
									</altova:table-cell>
									<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
								...
								<altova:table-row>
									...
									<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\sl0">
										...
										<altova:text-block>
											<xsl:text>\u65?\u98?\u98?\u114?\u101?\u118?\u105?\u97?\u116?\u105?\u111?\u110?</xsl:text>
										</altova:text-block>
									</altova:table-cell>
									<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
								...
								<altova:table-row>
									...
									<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\sl0">
										...
										<altova:text-block>
											<xsl:text>\u67?\u108?\u97?\u115?\u115?\u105?\u102?\u105?\u99?\u97?\u116?\u105?\u111?\u110?\u32?\u84?\u121?\u112?\u101?\u32?\u78?\u97?\u109?\u101?</xsl:text>
										</altova:text-block>
									</altova:table-cell>
									<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
								...
								<altova:table-row>
									...
									<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\sl0">
										...
										<altova:text-block>
											<xsl:text>\u79?\u98?\u106?\u101?\u99?\u116?\u32?\u84?\u121?\u112?\u101?\u32?\u78?\u97?\u109?\u101?</xsl:text>
										</altova:text-block>
									</altova:table-cell>
									<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
										<altova:TableCellStyles altova:nColSpan="1">
									...
									<altova:table>
										...
										<altova:table-row>
											...
											<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\sl0">
												...
												<altova:text-block>
													<xsl:text>\u78?\u117?\u109?\u98?\u101?\u114?\u32?\u79?\u102?\u32?\u67?\u111?\u108?\u117?\u109?\u110?\u115?</xsl:text>
												</altova:text-block>
											</altova:table-cell>
											<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qr\sl0">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<altova:Borders>
														<altova:Top>
										...
										<altova:table-row>
											...
											<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\sl0">
												...
												<altova:text-block>
													<xsl:text>\u78?\u117?\u109?\u98?\u101?\u114?\u32?\u79?\u102?\u32?\u82?\u111?\u119?\u115?\u32?\u77?\u105?\u110?\u46?</xsl:text>
												</altova:text-block>
											</altova:table-cell>
											<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qr\sl0">
												<altova:TableCellStyles altova:nColSpan="1">
										...
										<altova:table-row>
											...
											<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\sl0">
												...
												<altova:text-block>
													<xsl:text>\u78?\u117?\u109?\u98?\u101?\u114?\u32?\u79?\u102?\u32?\u82?\u111?\u119?\u115?\u32?\u77?\u97?\u120?\u46?</xsl:text>
												</altova:text-block>
											</altova:table-cell>
											<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qr\sl0">
												<altova:TableCellStyles altova:nColSpan="1">
										...
										<altova:table-row>
											...
											<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\sl0">
												...
												<altova:text-block>
													<xsl:text>\u69?\u120?\u112?\u101?\u99?\u116?\u101?\u100?\u32?\u78?\u117?\u109?\u98?\u101?\u114?\u32?\u79?\u102?\u32?\u82?\u111?\u119?\u115?</xsl:text>
												</altova:text-block>
											</altova:table-cell>
											<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qr\sl0">
												<altova:TableCellStyles altova:nColSpan="1">
										...
										<altova:table-row>
											...
											<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\sl0">
												...
												<altova:text-block>
													<xsl:text>\u69?\u120?\u112?\u101?\u99?\u116?\u101?\u100?\u32?\u71?\u114?\u111?\u119?\u116?\u104?</xsl:text>
												</altova:text-block>
											</altova:table-cell>
											<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qr\sl0">
												<altova:TableCellStyles altova:nColSpan="1">
										...
										<altova:table-row>
											...
											<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\sl0">
												...
												<altova:text-block>
													<xsl:text>\u71?\u114?\u111?\u119?\u116?\u104?\u32?\u73?\u110?\u116?\u101?\u114?\u118?\u97?\u108?</xsl:text>
												</altova:text-block>
											</altova:table-cell>
											<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qr\sl0">
												<altova:TableCellStyles altova:nColSpan="1">
							...
							<xsl:if test="count( n1:DiagramsCollection)">
								<altova:new-line/>
								<altova:text-block altova:character-styles="\fs16\i" altova:character-reset-styles="\fs24\i0">
							...
							<xsl:if test="count( n1:ColumnsCollection )">
								...
								<altova:table>
									...
									<altova:TableGrid>
										...
										<altova:GridCol altova:sWidth="454" altova:sType="twips"/>
										<altova:GridCol altova:sWidth="454" altova:sType="twips"/>
										<altova:GridCol altova:sWidth="454" altova:sType="twips"/>
										<altova:GridCol altova:sWidth="2268" altova:sType="twips"/>
										<altova:GridCol altova:sWidth="567" altova:sType="twips"/>
										<altova:GridCol altova:sWidth="1644" altova:sType="twips"/>
										<altova:GridCol altova:sWidth="1644" altova:sType="twips"/>
										<altova:GridCol altova:sWidth="1644" altova:sType="twips"/>
										<altova:GridCol altova:sWidth="1644" altova:sType="twips"/>
									</altova:TableGrid>
									...
									<altova:table-row>
										...
										<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\qc\sl0">
											...
											<altova:text-block>
												<xsl:text>\u68?\u84?\u32?</xsl:text>
											</altova:text-block>
											<altova:new-line/>
											<altova:text-block>
												<xsl:text>\u107?\u105?\u110?\u100?</xsl:text>
											</altova:text-block>
										</altova:table-cell>
										<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\qc\sl0">
											<altova:TableCellStyles altova:nColSpan="1">
											...
											<altova:text-block>
												<xsl:text>\u68?\u111?\u109?\u97?\u105?\u110?\u32?\u78?\u97?\u109?\u101?</xsl:text>
											</altova:text-block>
										</altova:table-cell>
										<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\qc\sl0">
											<altova:TableCellStyles altova:nColSpan="1">
											...
											<altova:text-block>
												<xsl:text>\u70?\u111?\u114?\u109?\u117?\u108?\u97?</xsl:text>
											</altova:text-block>
											<altova:new-line/>
											<altova:text-block>
												<xsl:text>\u40?\u68?\u101?\u102?\u97?\u117?\u108?\u116?\u32?\u86?\u97?\u108?\u117?\u101?\u41?</xsl:text>
											</altova:text-block>
										</altova:table-cell>
										<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\qc\sl0">
											<altova:TableCellStyles altova:nColSpan="1">
									...
									<xsl:for-each select="n1:ColumnsCollection">
										<xsl:for-each select="n1:ColumnDetails">
											<altova:table-row>
												...
												<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<altova:Borders>
															<altova:Bottom>
							...
							<xsl:if test="count( n1:IndexesCollection )">
								<altova:new-line/>
								<altova:text-block altova:character-styles="\fs16\i" altova:character-reset-styles="\fs24\i0">
									<xsl:text>\u73?\u110?\u100?\u101?\u120?\u101?\u115?</xsl:text>
								</altova:text-block>
								<xsl:variable name="altova:CurrContextGrid_10" select="."/>
								<altova:table>
									<xsl:variable name="altova:ColumnData"/>
									<altova:TableGrid>
										<altova:GridCol altova:sWidth="3969" altova:sType="twips"/>
										<altova:GridCol altova:sWidth="850" altova:sType="twips"/>
										<altova:GridCol altova:sWidth="1134" altova:sType="twips"/>
										<altova:GridCol altova:sWidth="850" altova:sType="twips"/>
										<altova:GridCol altova:sWidth="3118" altova:sType="twips"/>
										<altova:GridCol altova:sWidth="3402" altova:sType="twips"/>
										<altova:GridCol altova:sWidth="850" altova:sType="twips"/>
									</altova:TableGrid>
									<altova:TableStyles altova:nBorderSpacingPt="0.00" altova:sBorderCollapse="separate" altova:nCellPaddingPt="2.25" altova:nLeftMarginPt="0.00">
									...
									<altova:table-row>
										...
										<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\qc\sl0">
											...
											<altova:text-block>
												<xsl:text>\u73?\u110?\u100?\u101?\u120?\u32?\u78?\u97?\u109?\u101?</xsl:text>
											</altova:text-block>
										</altova:table-cell>
										<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\qc\sl0">
											<altova:TableCellStyles altova:nColSpan="1">
											...
											<altova:text-block>
												<xsl:text>\u83?\u116?\u97?\u116?\u101?</xsl:text>
											</altova:text-block>
										</altova:table-cell>
										<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\qc\sl0">
											<altova:TableCellStyles altova:nColSpan="1">
											...
											<altova:text-block>
												<xsl:text>\u70?\u117?\u110?\u99?\u116?\u105?\u111?\u110?\u97?\u108?</xsl:text>
											</altova:text-block>
										</altova:table-cell>
										<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\qc\sl0">
											<altova:TableCellStyles altova:nColSpan="1">
											...
											<altova:text-block>
												<xsl:text>\u83?\u112?\u97?\u116?\u105?\u97?\u108?</xsl:text>
											</altova:text-block>
										</altova:table-cell>
										<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\qc\sl0">
											<altova:TableCellStyles altova:nColSpan="1">
											...
											<altova:text-block>
												<xsl:text>\u69?\u120?\u112?\u114?\u101?\u115?\u115?\u105?\u111?\u110?</xsl:text>
											</altova:text-block>
										</altova:table-cell>
										<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\qc\sl0">
											<altova:TableCellStyles altova:nColSpan="1">
										...
										<altova:table-cell altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\qc\sl0">
											...
											<altova:text-block>
												<xsl:text>\u83?\u111?\u114?\u116?</xsl:text>
											</altova:text-block>
											<altova:new-line/>
											<altova:text-block>
												<xsl:text>\u79?\u114?\u100?\u101?\u114?</xsl:text>
											</altova:text-block>
										</altova:table-cell>
									</altova:table-row>
							...
							<xsl:if test="count( n1:ConstraintsCollection )">
								<altova:new-line/>
								<altova:text-block altova:character-styles="\fs16\i" altova:character-reset-styles="\fs24\i0">
									<xsl:text>\u67?\u111?\u110?\u115?\u116?\u114?\u97?\u105?\u110?\u116?\u115?</xsl:text>
								</altova:text-block>
								<altova:new-line/>
								<xsl:variable name="altova:CurrContextGrid_11" select="."/>
								<xsl:variable name="altova:table">
									<altova:table altova:hide-rows="body-empty" altova:hide-cols="body-empty">
										<xsl:variable name="altova:ColumnData"/>
										<altova:TableGrid>
										...
										<altova:table-row>
											...
											<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
												...
												<altova:text-block>
													<xsl:text>\u84?\u121?\u112?\u101?</xsl:text>
												</altova:text-block>
											</altova:table-cell>
											<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
												<altova:TableCellStyles altova:nColSpan="1">
												...
												<altova:text-block>
													<xsl:text>\u67?\u111?\u108?\u117?\u109?\u110?\u32?\u47?\u32?\u67?\u111?\u110?\u115?\u116?\u114?\u97?\u105?\u110?\u116?\u32?\u78?\u97?\u109?\u101?</xsl:text>
												</altova:text-block>
											</altova:table-cell>
											<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
												<altova:TableCellStyles altova:nColSpan="1">
												...
												<altova:text-block>
													<xsl:text>\u68?\u101?\u116?\u97?\u105?\u108?\u115?</xsl:text>
												</altova:text-block>
											</altova:table-cell>
										</altova:table-row>
											...
											<xsl:for-each select="n1:TableLevelConstraintsCollection">
												<xsl:for-each select="n1:TableLevelConstraintDetails">
													<altova:table-row>
														...
														<altova:table-cell altova:is-body-cell="true" altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
															<altova:TableCellStyles altova:nColSpan="1">
																<xsl:text>\clvertalt</xsl:text>
																<altova:Borders>
																	<altova:Bottom>
														...
														<altova:table-cell altova:is-body-cell="true" altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
															...
															<xsl:if test="count( n1:RangesCollection ) != 0">
																...
																<altova:table>
																	...
																	<altova:TableGrid>
																		<altova:GridCol altova:sWidth="1701" altova:sType="twips"/>
																		<altova:GridCol altova:sWidth="1701" altova:sType="twips"/>
																		<altova:GridCol altova:sWidth="7087" altova:sType="twips"/>
																	</altova:TableGrid>
																	<altova:TableStyles altova:nBorderSpacingPt="0.00" altova:sBorderCollapse="separate" altova:nCellPaddingPt="2.25" altova:nLeftMarginPt="0.00">
																		<xsl:text>\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
																		<altova:TableWidth altova:sWidth="{'18.5cm'}"/>
																	</altova:TableStyles>
																	<altova:table-row>
																		<xsl:element name="altova:TableRowStyles">
																			<xsl:text>\trrh0\trhdr</xsl:text>
																		...
																		<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
																			<altova:TableCellStyles altova:nColSpan="3">
																				<xsl:text>\clmgf</xsl:text>
																				<xsl:text>\clvertalt</xsl:text>
																				<xsl:element name="altova:TableCellColor">
																					<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
																				</xsl:element>
																			...
																			<altova:text-block>
																				<xsl:text>\u82?\u97?\u110?\u103?\u101?\u115?</xsl:text>
																			</altova:text-block>
																		</altova:table-cell>
																		<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
																			<altova:TableCellStyles altova:nColSpan="1">
																	...
																	<altova:table-row>
																		...
																		<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
																			...
																			<altova:text-block>
																				<xsl:text>\u66?\u101?\u103?\u105?\u110?\u32?\u86?\u97?\u108?\u117?\u101?</xsl:text>
																			</altova:text-block>
																		</altova:table-cell>
																		<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
																			<altova:TableCellStyles altova:nColSpan="1">
																			...
																			<altova:text-block>
																				<xsl:text>\u69?\u110?\u100?\u32?\u86?\u97?\u108?\u117?\u101?</xsl:text>
																			</altova:text-block>
																		</altova:table-cell>
																		<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
																			<altova:TableCellStyles altova:nColSpan="1">
															...
															<xsl:if test="count( n1:ValueListsCollection ) != 0">
																...
																<altova:table>
																	...
																	<altova:TableGrid>
																		<altova:GridCol altova:sWidth="1701" altova:sType="twips"/>
																		<altova:GridCol altova:sWidth="8787" altova:sType="twips"/>
																	</altova:TableGrid>
																	<altova:TableStyles altova:nBorderSpacingPt="0.00" altova:sBorderCollapse="separate" altova:nCellPaddingPt="2.25" altova:nLeftMarginPt="0.00">
																		<xsl:text>\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
																		<altova:TableWidth altova:sWidth="{'18.5cm'}"/>
																	...
																	<altova:table-row>
																		...
																		<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
																			<altova:TableCellStyles altova:nColSpan="2">
																				<xsl:text>\clmgf</xsl:text>
																				<xsl:text>\clvertalt</xsl:text>
																				<xsl:element name="altova:TableCellColor">
																					<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
																			...
																			<altova:text-block>
																				<xsl:text>\u86?\u97?\u108?\u117?\u101?\u32?\u76?\u105?\u115?\u116?</xsl:text>
																			</altova:text-block>
																		</altova:table-cell>
																		<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
																			<altova:TableCellStyles altova:nColSpan="1">
																	...
																	<altova:table-row>
																		...
																		<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
																			...
																			<altova:text-block>
																				<xsl:text>\u86?\u97?\u108?\u117?\u101?</xsl:text>
																			</altova:text-block>
																		</altova:table-cell>
																		<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
																			<altova:TableCellStyles altova:nColSpan="1">
																...
																<altova:table>
																	...
																	<altova:table-row>
																		...
																		<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
																			...
																			<altova:text-block>
																				<xsl:text>\u67?\u104?\u101?\u99?\u107?\u32?\u67?\u111?\u110?\u115?\u116?\u114?\u97?\u105?\u110?\u116?</xsl:text>
																			</altova:text-block>
																		</altova:table-cell>
																		<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
																			<altova:TableCellStyles altova:nColSpan="1">
																	...
																	<altova:table-row>
																		...
																		<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
																			...
																			<altova:text-block>
																				<xsl:text>\u84?\u101?\u120?\u116?</xsl:text>
																			</altova:text-block>
																		</altova:table-cell>
																		<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qc\sl0">
																			<altova:TableCellStyles altova:nColSpan="1">
																			...
																			<altova:text-block>
																				<xsl:text>\u68?\u66?\u32?\u84?\u121?\u112?\u101?</xsl:text>
																			</altova:text-block>
																		</altova:table-cell>
																	</altova:table-row>
								...
								<xsl:variable name="altova:col-count" select="sum(for $altova:cell in $altova:table/altova:table/altova:table-row[1]/altova:table-cell return altova:col-span($altova:cell))"/>
								<xsl:variable name="altova:generate-cols" as="xs:boolean*">
									<xsl:choose>
										<xsl:when test="$altova:table/altova:table/@altova:hide-cols = 'empty'">
											<xsl:sequence select="for $altova:pos in 1 to $altova:col-count return some $altova:cell in $altova:table/altova:table/altova:table-row/altova:table-cell[altova:col-position(.) = $altova:pos] satisfies not(altova:is-cell-empty($altova:cell))"/>
										</xsl:when>
										<xsl:otherwise>
											<xsl:sequence select="for $altova:pos in 1 to $altova:col-count return some $altova:cell in $altova:table/altova:table/altova:table-row/altova:table-cell[@altova:is-body-cell = 'true' and altova:col-position(.) = $altova:pos] satisfies not(altova:is-cell-empty($altova:cell))"/>
										</xsl:otherwise>
									</xsl:choose>
								</xsl:variable>
	...
	<xsl:template name="altova:Section_0_FooterRight">
		...
		<altova:table>
			<xsl:variable name="altova:ColumnData"/>
			<altova:TableGrid>
				<altova:GridCol altova:sWidth="10205" altova:sType="twips"/>
				<altova:GridCol altova:sWidth="3969" altova:sType="twips"/>
			</altova:TableGrid>
			<altova:TableStyles altova:nBorderSpacingPt="0.00" altova:sBorderCollapse="separate" altova:nCellPaddingPt="2.25" altova:nLeftMarginPt="0.00">
				<xsl:text>\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
			...
			<altova:table-row>
				...
				<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
					...
					<altova:text-block>
						<xsl:text>\u79?\u114?\u97?\u99?\u108?\u101?\u32?\u68?\u97?\u116?\u97?\u32?\u77?\u111?\u100?\u101?\u108?\u101?\u114?</xsl:text>
					</altova:text-block>
				</altova:table-cell>
				<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\qr\sl0">
					<altova:TableCellStyles altova:nColSpan="1">
	...
	<xsl:template name="altova:Section_3_FooterRight">
		<xsl:variable name="templatetablelevel" select="0"/>
	...
	<xsl:template name="altova:Section_3_FooterLeft">
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_18" select="."/>
		<altova:table>
			<xsl:variable name="altova:ColumnData"/>
	...
	<xsl:function name="altova:is-cell-empty" as="xs:boolean">
		...
		<xsl:sequence select="not(exists($altova:cell/child::node() except $altova:cell/altova:TableCellStyles))"/>
	</xsl:function>
	...
	<xsl:template match="altova:table-row" mode="altova:generate-table">
		<xsl:param name="altova:generate-cols"/>
		<xsl:choose>
			<xsl:when test="ancestor::altova:table[ 1 ]/@altova:hide-rows = 'empty'">
				<xsl:if test="some $altova:cell in altova:table-cell satisfies not( altova:is-cell-empty( $altova:cell ) )">
					<xsl:copy>
						<xsl:apply-templates select="@* | node()" mode="#current">
							<xsl:with-param name="altova:generate-cols" select="$altova:generate-cols"/>
						</xsl:apply-templates>
			...
			<xsl:when test="ancestor::altova:table[ 1 ]/@altova:hide-rows = 'body-empty'">
				<xsl:if test="not( exists( altova:table-cell[ @altova:is-body-cell = 'true' ] ) ) or ( some $altova:cell in altova:table-cell[ @altova:is-body-cell = 'true' ] satisfies not( altova:is-cell-empty( $altova:cell ) ) )">
					<xsl:copy>
						<xsl:apply-templates select="@* | node()" mode="#current">
							<xsl:with-param name="altova:generate-cols" select="$altova:generate-cols"/>
						</xsl:apply-templates>
	...
	<xsl:function name="altova:col-position" as="xs:integer">
		<xsl:param name="altova:cell" as="element()"/>
		<xsl:sequence select="sum( for $altova:cell-before in $altova:cell/preceding-sibling::altova:table-cell return altova:col-span( $altova:cell-before ) ) + 1"/>
	</xsl:function>
	...
	<xsl:template match="altova:table-cell" mode="altova:generate-table">
		<xsl:param name="altova:generate-cols"/>
	...
	<xsl:variable name="altova:non-xpath-colors-in-use" select="('BLUE','GRAY','BLACK')"/>
	...
	<xsl:variable name="altova:character-style-selectors-in-use" select="()"/>
	...
	<xsl:template match="/">
		<xsl:for-each select="$altova:nodesAllSeparateDocuments">
			...
			<xsl:result-document href="{$altova:nodeDocument/@altova:Url}">
				...
				<xsl:text>{\s1\f0\fs24\snext0 Normal;}</xsl:text>
		...
		<xsl:choose>
			<xsl:when test="altova:Watermark">
				<xsl:if test="altova:Watermark/@altova:sCondition = true()">
					...
					<xsl:text>{\*}</xsl:text>
					<xsl:value-of select="unparsed-text($sFilePath, 'binarytobase16')"/>
				...
				<xsl:choose>
					...
					<xsl:otherwise>
						...
						<xsl:if test="@altova:ImageDataBase64">
							<xsl:result-document href="{@altova:SrcUrl}" method="text" encoding="base64tobinary">
	...
	<xsl:template match="altova:line" mode="altova:rtf">
		...
		<xsl:value-of select="altova:GenerateRtfShapePropertyInt('lineWidth', altova:MapUnitPtToEmu(altova:MapUnitPxToPt(@altova:sSizePx)))"/>
		<!-- Line color -->
	...
	<xsl:template match="altova:list" mode="altova:rtf">
		...
		<xsl:if test="not($bIsDirectlyInBlockLevelAncestor or name(following-sibling::*[1]) eq 'altova:new-line')">
			<!--<xsl:variable name="nDepth" as="xs:integer" select="count(ancestor::altova:table)"/>-->
			<xsl:text>\pard</xsl:text>
			<xsl:if test="$nDepth &gt; 0">
				<xsl:text>\intbl</xsl:text>
