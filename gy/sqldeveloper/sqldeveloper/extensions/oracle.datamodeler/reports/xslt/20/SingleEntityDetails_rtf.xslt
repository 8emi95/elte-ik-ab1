			...
			<xsl:for-each select="$XML">
				<xsl:for-each select="n1:root">
											...
											<xsl:choose>
												...
												<xsl:when test="$SV_OutputFormat = &apos;HTML&apos;">
													<xsl:choose>
														...
														<xsl:otherwise>
															<altova:text-block altova:character-styles="\fs18" altova:character-reset-styles="\fs24">
																<xsl:text>\u32?</xsl:text>
															</altova:text-block>
														</xsl:otherwise>
													</xsl:choose>
					...
					<xsl:if test="count( n1:RelationshipsCollection )">
						<altova:new-line/>
						<altova:text-block altova:character-styles="\i" altova:character-reset-styles="\i0">
							<xsl:text>\u72?\u97?\u115?\u32?</xsl:text>
						</altova:text-block>
						<altova:text-block altova:character-styles="\fs16\i" altova:character-reset-styles="\fs24\i0">
							<xsl:text>\u82?\u101?\u108?\u97?\u116?\u105?\u111?\u110?\u115?\u104?\u105?\u112?\u115?\u32?</xsl:text>
						</altova:text-block>
						<altova:text-block altova:character-styles="\i" altova:character-reset-styles="\i0">
							<xsl:text>\u87?\u105?\u116?\u104?</xsl:text>
						</altova:text-block>
					...
					<xsl:if test="count( n1:IncomingProcessesCollection )">
						<altova:new-line/>
						<altova:text-block altova:character-styles="\fs16\i" altova:character-reset-styles="\fs24\i0">
							<xsl:text>\u73?\u110?\u99?\u111?\u109?\u105?\u110?\u103?\u32?</xsl:text>
						</altova:text-block>
						<altova:text-block altova:character-styles="\i" altova:character-reset-styles="\i0">
							<xsl:text>\u80?\u114?\u111?\u99?\u101?\u115?\u115?\u101?\u115?</xsl:text>
						</altova:text-block>
