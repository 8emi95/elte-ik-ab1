...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_at" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
								...
								<xsl:for-each select="n1:root">
									...
									<fo:block margin-right="100% - 100%" text-align="center" space-before="0" space-after="0" margin="0pt">
										<xsl:for-each select="n1:ReportCaption">
											<altova:inline-container-substitute font-size="medium" font-weight="bold">
												<xsl:apply-templates/>
											</altova:inline-container-substitute>
										</xsl:for-each>
									</fo:block>
																	...
																	<fo:block-container overflow="hidden">
																		<fo:block text-align="left">
																			<xsl:for-each select="n1:SWName">
																				<altova:hyperlink href="{.}" text-decoration="underline" color="blue">
																		...
																		<fo:block text-align="left">
																			<xsl:for-each select="n1:SWObjects">
																				<xsl:for-each select="n1:SWObject">
																					<altova:hyperlink href="{concat(&apos;#&apos;,.)}" text-decoration="underline" color="blue">
																						<altova:inline-container-substitute>
																							<xsl:apply-templates/>
																						</altova:inline-container-substitute>
																						<altova:line-break/>
									...
									<xsl:for-each select="n1:TablesCollection">
										<xsl:for-each select="n1:TableDetails">
											...
											<xsl:if test="count( n1:ConstraintsCollection )">
												...
												<altova:line-break/>
												<xsl:variable name="altova:table">
													<fo:table width="25cm" table-layout="fixed" border-spacing="0" altova:hide-rows="body-empty" altova:hide-cols="body-empty">
															...
															<xsl:for-each select="n1:ConstraintsCollection">
																<xsl:for-each select="n1:TableLevelConstraintsCollection">
																	<xsl:for-each select="n1:TableLevelConstraintDetails">
																		<fo:table-row>
																			<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thin" border-left-color="black" border-left-style="solid" border-left-width="thin" border-right-color="black" border-right-style="solid" border-right-width="thin" font-size="xx-small" padding="3" display-align="before" altova:is-body-cell="true">
																				<fo:block-container overflow="hidden">
																					<fo:block text-align="left">
																						<xsl:choose>
																							<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
																			...
																			<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thin" border-right-color="black" border-right-style="solid" border-right-width="thin" font-size="xx-small" padding="3" display-align="before" altova:is-body-cell="true">
																				<fo:block-container overflow="hidden">
																					<fo:block text-align="left">
																						<xsl:choose>
																							<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
													...
													<xsl:variable name="altova:generate-cols" as="xs:boolean*">
														<xsl:choose>
															<xsl:when test="$altova:table/fo:table/@altova:hide-cols = 'empty'">
																<xsl:sequence select="for $altova:pos in 1 to $altova:col-count return some $altova:cell in $altova:table/fo:table/(fo:table-header | fo:table-body | fo:table-footer)/fo:table-row/fo:table-cell[ altova:col-position( . ) = $altova:pos ] satisfies not( altova:is-cell-empty( $altova:cell ) )"/>
															</xsl:when>
															<xsl:otherwise>
																<xsl:sequence select="for $altova:pos in 1 to $altova:col-count return some $altova:cell in $altova:table/fo:table/fo:table-body/fo:table-row/fo:table-cell[ altova:col-position( . ) = $altova:pos ] satisfies not( altova:is-cell-empty( $altova:cell ) )"/>
															</xsl:otherwise>
														</xsl:choose>
													</xsl:variable>
	...
	<xsl:function name="altova:col-position" as="xs:integer">
		<xsl:param name="altova:cell" as="element()"/>
		<xsl:sequence select="sum( for $altova:cell-before in $altova:cell/preceding-sibling::fo:table-cell return altova:col-span( $altova:cell-before ) ) + 1"/>
	</xsl:function>
