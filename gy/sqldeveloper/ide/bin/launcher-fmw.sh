...
AddVMOptionJRockit()
{
  APP_VM_OPTS_JROCKIT[${#APP_VM_OPTS_JROCKIT[*]}]="$*"
}
AddVMOptionHotspot()
{
  APP_VM_OPTS_HOTSPOT[${#APP_VM_OPTS_HOTSPOT[*]}]="$*"
}
AddVMOptionHotspot6()
{
  APP_VM_OPTS_HOTSPOT6[${#APP_VM_OPTS_HOTSPOT6[*]}]="$*"
}
AddVMOptionHotspot7()
{
  APP_VM_OPTS_HOTSPOT7[${#APP_VM_OPTS_HOTSPOT7[*]}]="$*"
}
