...
EXECUTE dbms_output.put_line('Start creation of public synonyms on views, packages and types and grant to access to public. ' || systimestamp);
...
EXECUTE dbms_output.put_line('Finshed creation of public synonyms on views, packages and types and grant to access to public. ' || systimestamp);
