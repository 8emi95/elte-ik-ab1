...
<xs:schema xmlns="http://xmlns.oracle.com/odmr11"
           ...
           version="11.2.0.1.9" xdb:storeVarrayAsTable="true">
      ...
      <xs:complexType>
       <xs:sequence>
        <xs:element name="AnomalyDetectionModel"
                    ...
                    maxOccurs="unbounded" xdb:defaultTable="ANOM_DETECT_M_TAB" xdb:SQL';

schema2 := 'Inline="false"/>
       </xs:sequence>
      </xs:complexType>
     </xs:element>
    </xs:sequence>
  ...
  <xs:sequence>
   <xs:element name="Token">
    <xs:complexType>
     ...
     <xs:attribute name="MaxNumberAllDocs" use="required">
      <xs:simpleType>
       <xs:restriction base="xs:integer">
        <xs:minExclusive value="0"/>
       </xs:restriction>
...
';
    ...
    DBMS_XMLSCHEMA.registerSchema(
      ...
      schemadoc => schema1||schema2||schema3||schema4||schema5||schema6,
      local => FALSE,
      gentypes => TRUE,
      genbean => FALSE,
      gentables => TRUE,
