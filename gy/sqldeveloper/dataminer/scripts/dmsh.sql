...
--PASSWORD SH UNLOCK;
BEGIN
v_sql := 'CREATE VIEW "&USER_ACCOUNT".mining_data_apply_v AS
SELECT
 a.CUST_ID,
 a.CUST_GENDER,
...
BEGIN
v_sql := 'CREATE VIEW "&USER_ACCOUNT".mining_data_build_v AS
SELECT
 a.CUST_ID,
 a.CUST_GENDER,
 2003-a.CUST_YEAR_OF_BIRTH AGE,
...
BEGIN
v_sql := 'CREATE VIEW "&USER_ACCOUNT".mining_data_test_v AS
SELECT
 a.CUST_ID,
 a.CUST_GENDER,
 2003-a.CUST_YEAR_OF_BIRTH AGE,
...
BEGIN
v_sql := 'CREATE VIEW "&USER_ACCOUNT".mining_data_text_apply_v AS
SELECT
 a.CUST_ID,
 a.CUST_GENDER,
 2003-a.CUST_YEAR_OF_BIRTH AGE,
...
BEGIN
v_sql := 'CREATE VIEW "&USER_ACCOUNT".mining_data_text_build_v AS
SELECT
 a.CUST_ID,
 a.CUST_GENDER,
 2003-a.CUST_YEAR_OF_BIRTH AGE,
...
BEGIN
v_sql := 'CREATE VIEW "&USER_ACCOUNT".mining_data_text_test_v AS
SELECT
 a.CUST_ID,
 a.CUST_GENDER,
 2003-a.CUST_YEAR_OF_BIRTH AGE,
